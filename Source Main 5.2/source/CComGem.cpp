...
constexpr int kAttachValue     = 1'000'000;
constexpr int kDetachUnitValue = 50'000;
  ...
  if ( !CheckMyInvValid() ) {
    switch ( GetError() ) {
      case COMERROR_NOTALLOWED:
        g_pSystemLogBox->AddText( GlobalText[1'817], SEASON3B::TYPE_ERROR_MESSAGE );
        break;
...
int COMGEM::CalcItemValue( const ITEM* p )
{
  ...
  switch ( CheckOneItem( p ) ) {
    case NOGEM:
      return 0;
    case eBLESS_C:
      return 9'000'000 * ( Level + 1 ) * FIRST;
    case eSOUL_C:
      return 6'000'000 * ( Level + 1 ) * FIRST;
    case eLIFE_C:
      return 45'000'000 * ( Level + 1 ) * FIRST;
    case eCREATE_C:
      return 36'000'000 * ( Level + 1 ) * FIRST;
    case ePROTECT_C:
      return 60'000'000 * ( Level + 1 ) * FIRST;
    case eCHAOS_C:
      return 810'000 * ( Level + 1 ) * FIRST;
    case eGEMSTONE_C:
    case eHARMONY_C:
    case eLOW_C:
    case eUPPER_C:
      return 18'600 * ( Level + 1 ) * FIRST;
    default:
      return 0;
  }
}
