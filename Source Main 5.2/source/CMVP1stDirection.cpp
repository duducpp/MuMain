...
namespace {
constexpr int kCrywolfNotifyDelayMs          = 5'000;
...
void CMVP1STDirection::BeginDirection1()
{
  if ( g_Direction.m_bAction ) {
    if ( g_Direction.m_iCheckTime == 0 ) {
      ...
      g_Direction.GetTimeCheck( 1'000 );
      ...
      g_Direction.GetTimeCheck( 2'000 );
    } else {
...
void CMVP1STDirection::BeginDirection5()
{
  if ( g_Direction.m_bAction ) {
    if ( g_Direction.m_iCheckTime == 0 ) {
      ...
      g_Direction.GetTimeCheck( 4'000 );
    } else {
      g_Direction.m_bAction = false;
    }
  } else {
