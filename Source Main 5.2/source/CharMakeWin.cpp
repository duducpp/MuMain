...
constexpr std::array<int, MAX_CLASS> kClassButtonTextIds{ 20, 21, 22, 23, 24, 1'687, 3'150 };

constexpr std::size_t kMinCharacterNameLength = 4;

constexpr int kSummonerDescriptionTextId    = 1'690;
constexpr int kRageFighterDescriptionTextId = 3'152;
constexpr int kDefaultDescriptionBase       = 1'705;

constexpr int            kStatLabelBaseId             = 1'701;
...
constexpr int            kDarkLordLeadershipTextId    = 1'738;
