...
constexpr int kDefaultClassTextIndex = 2'305;

constexpr std::array<ClassTextEntry, 18> kClassTextEntries{
  {
   { CLASS_WIZARD, 20 },
   { CLASS_SOULMASTER, 25 },
   { CLASS_GRANDMASTER, 1'669 },
   { CLASS_KNIGHT, 21 },
   { CLASS_BLADEKNIGHT, 26 },
   { CLASS_BLADEMASTER, 1'668 },
   { CLASS_ELF, 22 },
   { CLASS_MUSEELF, 27 },
   { CLASS_HIGHELF, 1'670 },
   { CLASS_DARK, 23 },
   { CLASS_DUELMASTER, 1'671 },
   { CLASS_DARK_LORD, 24 },
   { CLASS_LORDEMPEROR, 1'672 },
   { CLASS_SUMMONER, 1'687 },
   { CLASS_BLOODYSUMMONER, 1'688 },
   { CLASS_DIMENSIONMASTER, 1'689 },
   { CLASS_RAGEFIGHTER, 3'150 },
   { CLASS_TEMPLENIGHT, 3'151 },
   }
};
