...
public:
  ...
  /// Causes reaction on client side: The client will add the client in its list (if over 2 clients are connected to the
  /// same room), or show its name in the title bar.
  /// </remarks>
  ...
  /// </summary>
  /// <remarks>
  /// Is sent by the client when: This packet is sent by the client when it leaves the chat room, before the connection
  /// closes. Causes reaction on server side: The server will remove the client from the chat room, notifying the
  /// remaining clients.
  /// </remarks>
  ...
  /// Causes reaction on client side: The client will remove the client from its list, or mark its name in the title bar
  /// as offline.
  /// </remarks>
