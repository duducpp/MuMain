...
void PacketFunctions_ClientToServer::SendCashShopStorageItemConsumeRequest( uint32_t baseItemCode,
                                                                            uint32_t mainItemCode, uint16_t itemIndex,
                                                                            BYTE productType )
{
...
void PacketFunctions_ClientToServer::SendWalkRequest075( BYTE sourceX, BYTE sourceY, BYTE stepCount,
                                                         BYTE targetRotation, const BYTE* directions,
...
void PacketFunctions_ClientToServer::SendGuildKickPlayerRequest( const wchar_t* playerName,
                                                                 const wchar_t* securityCode )
{
...
void PacketFunctions_ClientToServer::SendGuildRelationshipChangeRequest( uint32_t relationshipType,
                                                                         uint32_t requestType, uint16_t targetPlayerId )
{
...
void PacketFunctions_ClientToServer::SendMuHelperSaveDataRequest( const BYTE* helperData,
                                                                  uint32_t    helperDataByteLength )
{
...
void PacketFunctions_ClientToServer::SendDuelStartResponse( BYTE response, uint16_t playerId,
