...
public:
  ...
  /// <remarks>
  /// Is sent by the client when: A player requests to pick up an item which is laying on the ground in the near of the
  /// players character. Causes reaction on server side: If the player is allowed to pick the item up, and is the first
  /// player which tried that, it tries to add the item to the inventory. The server sends a response about the result
  /// of the request.
  /// </remarks>
  ...
  /// item. Causes reaction on server side: The server tries to 'consume' the specified item and responses accordingly.
  /// </remarks>
  ...
  /// example, if it's a merchant NPC, it sends back that a merchant dialog should be opened and which items are offered
  /// by this NPC.
  /// </remarks>
  ...
  /// Causes reaction on server side: The item is sold for money to the NPC. The item is removed from the inventory and
  /// money is added. Corresponding messages are sent back to the game client.
  /// </remarks>
  ...
  /// </summary>
  /// <param name="itemSlot">Inventory item slot of the target item. If it's 0xFF, the player wants to repair all items
  /// - this is only possible with some opened NPC dialogs. Repairing the pet item slot (8) is only possible when the
  /// pet trainer npc is opened.</param> <param name="isSelfRepair">If the player repairs it over his inventory, it's
  /// true. However, a server should never rely on this flag and do his own checks.</param> <remarks> Is sent by the
  /// client when: A player wants to repair an item of his inventory. Causes reaction on server side: The item is
  /// repaired if the player has enough money in its inventory. A corresponding response is sent.
  /// </remarks>
  ...
  /// OpenMU.</param> <param name="warpInfoIndex">The index of the entry in the warp list.</param> <remarks> Is sent by
  /// the client when: A player selected to warp by selecting an entry in the warp list (configured in game client
  ...
  /// <remarks>
  /// Is sent by the client when: Usually: When the player enters an area on the game map which is configured as gate at
  /// the client data files. In the special case of wizards, this packet is also used for the teleport skill. When this
  /// is the case, GateNumber is 0 and the target coordinates are specified. Causes reaction on server side: If the
  /// player is allowed to enter the "gate", it's moved to the corresponding exit gate area.
  /// </remarks>
  ...
  /// registration. Causes reaction on server side: The server returns the state of the castle siege registration, which
  /// includes the number of submitted guild marks.
  /// </remarks>
  ...
  /// castle owners. Causes reaction on server side: The server returns the list of guilds which are the castle owners.
  /// </remarks>
  ...
  /// Causes reaction on server side: The server returns data about the state of the benefit of the crywolf event. If it
  /// was won before, the chaos rate wents up a few percent.
  /// </remarks>
  ...
  /// </summary>
  /// <remarks>
  /// Is sent by the client when: A player is running the quest "Infiltrate The Barracks of Balgass" (nr. 5), talking to
  /// the Werewolf npc in Crywolf. Causes reaction on server side: It will warp the player to the map 'Barracks of
  ...
  /// GoblinPoints) are available to the player. Causes reaction on server side: The server returns the cash shop points
  /// information.
  /// </remarks>
  ...
  /// Causes reaction on server side: The vault lock state on the server is updated. VaultProtectionInformation is sent
  /// as response.
  /// </remarks>
  ...
  /// <remarks>
  /// Is sent by the client when: A party master wants to kick another player from his party, or when a player wants to
  /// kick himself from his party. Causes reaction on server side: If the sending player is the party master, or the
  /// player wants to kick himself, the target player is removed from the party.
  /// </remarks>
  ...
  /// coordinates and applying the directions to it.</param> <param name="directionsByteLength">The length of <paramref
  /// name="directions"/> in bytes. <remarks> Is sent by the client when: A player wants to walk on the game map. Causes
  /// reaction on server side: The player gets moved on the map, visible for other surrounding players.
  /// </remarks>
  ...
  /// Causes reaction on server side: Usually, the player is moved instantly to the specified coordinates on the current
  /// map. In OpenMU, this request is not handled, because it allows hackers to "teleport" to any coordinates.
  /// </remarks>
  ...
  /// <remarks>
  /// Is sent by the client when: The game client is at the character selection screen and the player requests to add a
  /// new character. Causes reaction on server side: The server checks if the player is allowed to create the character
  ...
  /// account password (up to 20 bytes long) here. In OpenMU, we work with the security here, but are not limiting to a
  /// length of 7 bytes.</param> <remarks> Is sent by the client when: The game client is at the character selection
  /// screen and the player requests to delete an existing character. Causes reaction on server side: The server checks
  /// if the player transmitted the correct security code and if the character actually exists. If all is valid, it
  /// deletes the character from the account. It then sends a response with a result code back to the game client.
  /// </remarks>
  ...
  /// </summary>
  /// <remarks>
  /// Is sent by the client when: After the server sent a map change message and the client has initialized the game map
  /// visualization. Causes reaction on server side: The character is added to the internal game map and ready to
  ...
  /// <remarks>
  /// Is sent by the client when: The player wants to add or increase the level of a specific master skill of the master
  /// skill tree. Causes reaction on server side: Adds or increases the master skill level of the specified skill, if
  /// the character is allowed to do that. A response is sent back to the client.
  /// </remarks>
  ...
  /// 'Wizardy Enhance'. Causes reaction on server side: The effect is cancelled and an update is sent to the player and
  /// all surrounding players.
  /// </remarks>
  ...
  /// area of the map. Causes reaction on server side: It's forwarded to all surrounding players, so that the animation
  /// is visible. In the original server implementation, no damage is done yet for attack skills - there are separate
  /// hit packets.
  /// </remarks>
  ...
  /// lower than the amount which was set before, it's added back to the inventory. The trade partner is informed about
  /// any change.
  /// </remarks>
  ...
  /// from its guild. Causes reaction on server side: If the player is allowed to kick the player, it's removed from the
  /// guild. If the guild master kicks himself, the guild is disbanded. Corresponding responses are sent to all involved
  /// players.
  /// </remarks>
  ...
  /// Causes reaction on server side: If the request was accepted by the guild master, the previously requesting player
  /// is added to the guild.
  /// </remarks>
  ...
  /// <param name="guildEmblem">The guild emblem in a custom bitmap format. It supports 16 colors (one transparent) per
  /// pixel and has a size of 8 * 8 pixel.</param> <param name="guildEmblemByteLength">The length of <paramref
  /// name="guildEmblem"/> in bytes. <remarks> Is sent by the client when: When a player wants to create a guild. Causes
  /// reaction on server side: The guild is created and the player is set as the new guild master of the guild.
  /// </remarks>
  ...
  /// creation is cancelled and the dialog was closed.</param> <remarks> Is sent by the client when: The player has the
  /// dialog of the guild master NPC opened and decided about its next step. Causes reaction on server side: It either
  /// cancels the guild creation or proceeds with the guild creation dialog where the player can enter the guild name
  /// and symbol.
  /// </remarks>
  ...
  /// <param name="targetPlayerId">The target player id.</param>
  /// <remarks>
  /// Is sent by the client when: A guild master sends a request to another guild master about changing the relationship
  /// between their guilds. Causes reaction on server side: The server sends a response with the result.
  /// </remarks>
  ...
  /// </summary>
  /// <param name="inventoryItemSlot">The inventory slot of the target item. If it's 0xFF, the player requests to repair
  /// all items with the help of an NPC. If it's 8 (Pet slot), using the pet trainer NPC is mandatory, too.</param>
  /// <remarks>
  /// Is sent by the client when: A player wants to repair an item of his inventory, either himself or with the usage of
  /// an NPC. Causes reaction on server side: If the item is damaged and repairable, the durability of the item is
  /// maximized and corresponding responses are sent back to the client.
  /// </remarks>
  ...
  /// <param name="socketSlot">The 0-based slot index of the socket at which a seed sphere should be mounted or removed.
  /// May only be available for the corresponding mixes, so access with care.</param> <remarks> Is sent by the client
  /// when: The player has the dialog of the chaos machine open and decided to mix (craft) the items which he put into
  /// the chaos machine dialog. Causes reaction on server side: Based on the type of mix and it's corresponding success
  /// rate, the mix succeeds or fails. The client gets a corresponding response with the created, changed or lost items.
  /// </remarks>
  ...
  /// Causes reaction on server side: A request is sent to the other player. If the player is currently offline, the
  /// request will be sent as soon as he is online again.
  /// </remarks>
  ...
  /// messenger. Causes reaction on server side: The entry in the friend list is removed. The player is shown as offline
  /// in the other players friends list.
  /// </remarks>
  ...
  /// 213), Order of Protection, Restraint, Tracking or Weaken. Causes reaction on server side: The server checks if the
  /// player is inside the event etc. and performs the skills accordingly.
  /// </remarks>
  ...
  /// <param name="selectedTextIndex">A 1-based index of the selected index in the dialog. It's 0 when no text has been
  /// selected. It's not clear yet, when we need that.</param> <remarks> Is sent by the client when: The client opened
  /// an quest NPC dialog and selected an available quests. Causes reaction on server side: If the quest is already
  /// active, it responds with the QuestProgress. If the quest is inactive, the server decides if the character can
  /// start the quest and responds with a QuestStepInfo with the StartingNumber. A character can run up to 3 concurrent
  /// quests at a time.
  /// </remarks>
  ...
  /// <remarks>
  /// Is sent by the client when: After the server started a quest (and sent a F60B message) the game client requests to
  /// proceed with the quest. Causes reaction on server side: The quest state is set accordingly on the server. The next
  /// response seems to depend on the quest configuration. Depending on the action of the next quest state, the server
  /// will send either a quest progress message (F60C) or again a quest start message (F60B).
  /// </remarks>
  ...
  /// that the player can select to start the next quest. Additionally, the quest completion response message (F60D) is
  /// sent to the client.
  /// </remarks>
  ...
  /// reaction on server side: The server should check if the correct Quest NPC (e.g. Elf Soldier) dialog is opened and
  /// the player didn't reach the level limit yet. If that's both the case, it adds a defined buff (MagicEffect) to the
  /// player; Otherwise, a message is sent to the player.
  /// </remarks>
  ...
  /// <param name="ticketItemInventoryIndex">The index of the ticket item in the inventory. Be aware, that the value is
  /// 12 higher than it should be - it makes no sense, but it is what it is...</param> <remarks> Is sent by the client
  /// when: The player requests to enter the devil square through the Charon NPC. Causes reaction on server side: The
  /// server checks if the player can enter the event and sends a response (Code 0x90) back to the client. If it was
  /// successful, the character gets moved to the event map.
  /// </remarks>
  ...
  /// digits long. Causes reaction on server side: A response is sent back to the client with the result. An item could
  /// be rewarded to the inventory.
  /// </remarks>
  ...
  /// <param name="ticketItemInventoryIndex">The index of the ticket item in the inventory. Be aware, that the value is
  /// 12 higher than it should be - it makes no sense, but it is what it is...</param> <remarks> Is sent by the client
  /// when: The player requests to enter the blood castle through the Archangel Messenger NPC. Causes reaction on server
  /// side: The server checks if the player can enter the event and sends a response (Code 0x9A) back to the client. If
  /// it was successful, the character gets moved to the event map.
  /// </remarks>
  ...
  /// Causes reaction on server side: The remaining time is sent back to the client. However, it's not really handled on
  /// the known server sources.
  /// </remarks>
  ...
  /// Causes reaction on server side: The server checks if the player can enter the event and sends a response (Code
  /// 0xAF) back to the client. If it was successful, the character gets moved to the event map.
  /// </remarks>
  ...
  /// anymore. It requests to set the specified coordinates. Causes reaction on server side: The server sets the player
  /// on the new coordinates. Not handled on OpenMU.
  /// </remarks>
