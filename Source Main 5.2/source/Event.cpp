...
void CXmasEvent::CreateXmasEventEffect( CHARACTER* pCha, OBJECT* pObj, int iType )
{
  ...
  switch ( c->Object.SubType ) {
    case MODEL_XMAS_EVENT_CHA_SSANTA:
      CopyWideString( c->ID, GlobalText[2'245] );
      break;
    case MODEL_XMAS_EVENT_CHA_DEER:
      CopyWideString( c->ID, GlobalText[2'246] );
      break;
    case MODEL_XMAS_EVENT_CHA_SNOWMAN:
      CopyWideString( c->ID, GlobalText[2'247] );
      break;
    default:
...
const DWORD CBlueLuckyBagEvent::m_dwBlueLuckyBagCheckTime = 600'000;
