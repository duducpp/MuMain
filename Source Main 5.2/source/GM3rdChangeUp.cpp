...
bool SEASON3A::CGM3rdChangeUp::MoveObject( OBJECT* pObject )
{
  ...
  switch ( pObject->Type ) {
    ...
    case 3:
      ...
      break;
    case 57:
      pObject->BlendMeshTexCoordV = -(int)WorldTime % 10'000 * 0.0002f;
      break;
    case 84: {
  ...
  switch ( o->Type ) {
    ...
    case 78:
      ...
      b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                     -(int)WorldTime % 100'000 * 0.00001f, o->BlendMeshTexCoordV );
      b->StreamMesh = -1;
      break;
    case 84:
      b->StreamMesh = 0;
      float fLumi   = ( sinf( WorldTime * 0.001f ) + 1.f ) * 0.5f;
      b->RenderBody( RENDER_TEXTURE, o->Alpha, 0, fLumi, (int)WorldTime % 10'000 * 0.0001f, o->BlendMeshTexCoordV,
                     o->HiddenMesh );
      b->StreamMesh = -1;
      b->RenderBody( RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV, o->HiddenMesh );
