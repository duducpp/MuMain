  ...
  switch ( pObject->Type ) {
    ...
    case 66: {
      ...
      pModel->RenderMesh( 0, RENDER_TEXTURE, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          -(int)WorldTime % 100'000 * 0.00005f, pObject->BlendMeshTexCoordV );
      pModel->StreamMesh = -1;
    ...
    case 78: {
      ...
      pModel->StreamMesh = 0;
      pModel->RenderMesh( 0, RENDER_TEXTURE, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          (int)WorldTime % 100'000 * 0.0002f, pObject->BlendMeshTexCoordV );
      pModel->StreamMesh = -1;
      pModel->EndRender();
    } break;
  }
...
bool M33Aida::RenderAidaMonsterObjectMesh( OBJECT* pObject, BMD* pModel, bool ExtraMon )
{
  switch ( pObject->Type ) {
    case MODEL_GOLDEN_STONE_GOLEM: {
      ...
      pModel->StreamMesh = 0;
      pModel->RenderMesh( 0, RENDER_TEXTURE, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          -(int)WorldTime % 10'000 * 0.0003f, -(int)WorldTime % 10'000 * 0.0003f );
    ...
    case MODEL_DEATH_RIDER: {
      ...
      pModel->RenderMesh( 3, RENDER_TEXTURE, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          -(int)WorldTime % 10'000 * 0.0006f, -(int)WorldTime % 10'000 * 0.0006f );
