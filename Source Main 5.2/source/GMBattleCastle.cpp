...
static BYTE g_byGateLocation[6][2] = {
  { 67,  114 },
  { 93,  114 },
  { 119, 114 },
  { 81,  161 },
...
static float g_fGuardStoneLocation[4][2] = {
  { 8'200,  13'000 },
  { 10'700, 13'000 },
  { 9'400,  18'200 },
  { 9'400,  22'700 }
...
static constexpr float ArrowEffectOnBattlefieldInterval = 2'400; // every 2400 ms
...
bool CreateFireSnuff( PARTICLE* o )
{
  ...
  if ( gMapManager.WorldActive == WD_55LOGINSCENE ) {
    Vector( Hero->Object.Position[0] + (float)( rand() % 1'600 - 800 ),
            Hero->Object.Position[1] + (float)( rand() % 1'400 - 500 ),
            Hero->Object.Position[2] + (float)( rand() % 1'000 + 50 ), Position );
  } else {
    Vector( Hero->Object.Position[0] + (float)( rand() % 1'600 - 800 ),
            Hero->Object.Position[1] + (float)( rand() % 1'400 - 500 ),
  ...
  if ( IsBattleCastleStart() ) {
    ...
    if ( ( HeroY > 58 && HeroY < 113 ) || ( HeroY > 117 && HeroY < 159 ) ) {
      if ( LastArrowEffectOnBattlefield < WorldTime - ArrowEffectOnBattlefieldInterval ) {
        ...
        int dx                       = ( rand() % 1'400 - 700 ) - 60.f * length;
...
bool CreateBattleCastleObject( OBJECT* o )
{
  ...
  switch ( o->Type ) {
    ...
    case 41:
      o->Timer = float( rand() % 1'000 ) * 0.01f;
      break;
...
bool RenderBattleCastleObjectMesh( OBJECT* o, BMD* b )
{
  ...
  if ( o->Type == 12 ) {
    ...
    b->RenderBody( RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                   (int)WorldTime % 10'000 * 0.0002f, o->HiddenMesh );
    b->StreamMesh = -1;
    return true;
  } else if ( o->Type == 51 ) {
    b->StreamMesh = 0;
    b->RenderBody( RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                   -(int)WorldTime % 10'000 * 0.0002f, o->BlendMeshTexCoordV, o->HiddenMesh );
    b->StreamMesh = -1;
    return true;
  } else if ( o->Type == 66 ) {
    ...
    if ( IsBattleCastleStart() ) {
      ...
      b->RenderMesh( 3, RENDER_BRIGHT | RENDER_METAL, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV, BITMAP_CHROME );
      Vector( 1.f, 1.f, 1.f, b->BodyLight );
      b->EndRender();
    } else {
