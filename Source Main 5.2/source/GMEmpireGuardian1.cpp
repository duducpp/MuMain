      ...
      switch ( o->CurrentAction ) {
        ...
        case MONSTER01_ATTACK2: {
          if ( 4.0f <= o->AnimationFrame && o->AnimationFrame < 4.4f ) {
            ...
            CreateEffectFpsChecked( MODEL_DARK_SCREAM, pObj->Position, pObj->Angle, pObj->Light, 1, pObj, pObj->PKKey,
                                    SkillIndex );
...
bool GMEmpireGuardian1::RenderObjectMesh( OBJECT* o, BMD* b, bool ExtraMon )
{
  ...
  switch ( o->Type ) {
    ...
    case 115: {
      ...
      o->BlendMeshTexCoordV = (int)WorldTime % 25'000 * 0.0004f;
      b->StreamMesh         = 1;
      b->RenderMesh( 1, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV );
...
void GMEmpireGuardian1::RenderFrontSideVisual()
{
  switch ( m_iWeather ) {
    case WEATHER_FOG: {
      ...
      float WindX2 = (float)( (int)WorldTime % 100'000 ) * 0.00005f;
      float WindY2 = (float)( (int)WorldTime % 100'000 ) * 0.00008f;
      RenderBitmapUV( BITMAP_CHROME + 2, 0.f, 0.f, 640.f, 480.f - 45.f, WindX2, WindY2, 2.0f, 2.0f );
      float WindX = -(float)( (int)WorldTime % 100'000 ) * 0.00005f;
    ...
    case WEATHER_STORM: {
      if ( rand_fps_check( 20 ) ) {
        ...
        float WindX2 = (float)( (int)WorldTime % 100'000 ) * 0.0006f;
        float WindY2 = -(float)( (int)WorldTime % 100'000 ) * 0.0006f;
        RenderBitmapUV( BITMAP_CHROME + 2, 0.f, 0.f, 640.f, 480.f - 45.f, WindX2, WindY2, 3.0f, 2.0f );
        WindX2 = -(float)( (int)WorldTime % 100'000 ) * 0.0006f;
        WindY2 = (float)( (int)WorldTime % 100'000 ) * 0.0006f;
        RenderBitmapUV( BITMAP_CHROME + 2, 0.f, 0.f, 640.f, 480.f - 45.f, WindX2, WindY2, 3.0f, 2.0f );
      }
    } break;
  }
