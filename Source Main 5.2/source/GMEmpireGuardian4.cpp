      ...
      switch ( o->CurrentAction ) {
        case MONSTER01_ATTACK1: {
          ...
          if ( o->AnimationFrame >= 0.0f && o->AnimationFrame < 0.5f ) {
            ...
            CreateEffect( MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 1, o, -1, 0, 0, 0,
                          o->Scale );

            b->TransformPosition( o->BoneTransform[10], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 1, o, -1, 0, 0, 0,
                          o->Scale );
          }
        } break;
        case MONSTER01_ATTACK2: {
          ...
          if ( o->AnimationFrame >= 0.0f && o->AnimationFrame < 0.7f ) {
            ...
            CreateEffect( MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 1, o, -1, 0, 0, 0,
                          o->Scale );

            b->TransformPosition( o->BoneTransform[8], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 1, o, -1, 0, 0, 0,
                          o->Scale );
          }
        } break;
        case MONSTER01_ATTACK3: {
          if ( o->AnimationFrame >= 0.0f && o->AnimationFrame < 0.5f ) {
            ...
            b->TransformPosition( o->BoneTransform[4], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0,
                          o->Scale );

            b->TransformPosition( o->BoneTransform[8], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDRIGHT01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0,
                          o->Scale );

            b->TransformPosition( o->BoneTransform[2], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0,
                          o->Scale );

            b->TransformPosition( o->BoneTransform[10], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0,
                          o->Scale );

            b->TransformPosition( o->BoneTransform[6], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 3, o, -1, 0, 0, 0,
                          o->Scale );
          }
        } break;
        case MONSTER01_ATTACK4: {
          ...
          if ( o->AnimationFrame >= 0.0f && o->AnimationFrame < 0.5f ) {
            ...
            b->TransformPosition( o->BoneTransform[6], v3RelativePos, v3StartPos, true );
            CreateEffect( MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, v3StartPos, Angle, v3PosTo, 1, o, -1, 0, 0, 0,
                          o->Scale );
          }
        } break;
      ...
      switch ( o->CurrentAction ) {
        ...
        case MONSTER01_ATTACK2: {
          ...
          if ( 8.0f <= o->AnimationFrame && o->AnimationFrame < 10.1f ) {
            ...
            for ( int i = 0; i < 100; i++ ) {
              ...
              CreateJointFpsChecked( BITMAP_JOINT_THUNDER, vResultRandomPosition, vPosition, vAngle, 3, NULL, 10.f, 10,
                                     10 );
        ...
        case MONSTER01_ATTACK3: {
          if ( o->AnimationFrame >= 0.2f && o->AnimationFrame <= 1.0f ) {
            ...
            CreateEffect( MODEL_EMPIREGUARDIAN_BLOW_OF_DESTRUCTION, o->Position, o->Angle, o->Light, 0, o, -1, 0, 0, 0,
                          1.0f );
          }
...
bool GMEmpireGuardian4::RenderMonster( OBJECT* o, BMD* b, bool ExtraMon )
{
  switch ( o->Type ) {
    ...
    case MODEL_DEATH_ANGEL_3: {
      ...
      b->RenderMesh( 3, RENDER_BRIGHT | RENDER_CHROME, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV );
