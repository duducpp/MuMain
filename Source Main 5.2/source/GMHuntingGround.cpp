...
bool M31HuntingGround::CreateHuntingGroundObject( OBJECT* pObject )
{
  ...
  switch ( pObject->Type ) {
    case 27:
    case 54:
      pObject->Timer = float( rand() % 1'000 ) * 0.01f;
      break;
  }
...
bool M31HuntingGround::MoveHuntingGroundObject( OBJECT* pObject )
{
  ...
  //. 배경음악 컨트롤
  if ( ::timeGetTime() - g_MusicStartStamp > 300'000 ) {
  ...
  switch ( pObject->Type ) {
    ...
    case MODEL_FIRE_GOLEM: {
      ...
      pModel->RenderMesh( 0, RENDER_TEXTURE, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          (int)WorldTime % 10'000 * 0.0002f, (int)WorldTime % 10'000 * 0.0002f );
    ...
    case MODEL_EROHIM: {
      ...
      pModel->RenderMesh( 4, RENDER_CHROME | RENDER_BRIGHT, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          pObject->BlendMeshTexCoordU, pObject->BlendMeshTexCoordV );

      Vector( 0.75f, 0.65f, 0.5f, pModel->BodyLight );
      pModel->RenderMesh( 0, RENDER_CHROME | RENDER_BRIGHT, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          pObject->BlendMeshTexCoordU, pObject->BlendMeshTexCoordV );
      pModel->RenderMesh( 1, RENDER_CHROME | RENDER_BRIGHT, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          pObject->BlendMeshTexCoordU, pObject->BlendMeshTexCoordV );
      pModel->RenderMesh( 3, RENDER_CHROME | RENDER_BRIGHT, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                          pObject->BlendMeshTexCoordU, pObject->BlendMeshTexCoordV );
