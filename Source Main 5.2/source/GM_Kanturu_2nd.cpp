...
bool M38Kanturu2nd::Move_Kanturu2nd_Object( OBJECT* o )
{
  ...
  switch ( o->Type ) {
    ...
    case 42: {
      o->BlendMeshTexCoordU = -(int)WorldTime % 10'000 * 0.0002f;
  ...
  if ( Is_Kanturu2nd() == true ) {
    switch ( o->Type ) {
      ...
      case 12: {
        ...
        b->StreamMesh = 1;
        b->RenderBody( RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       -(int)WorldTime % 2'000 * 0.0005f, o->HiddenMesh );
        b->StreamMesh = -1;
        b->RenderMesh( 0, RENDER_TEXTURE, o->Alpha, 0, o->BlendMeshLight, (int)WorldTime % 2'000 * 0.0005f,
