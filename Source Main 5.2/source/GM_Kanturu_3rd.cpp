    ...
    switch ( o->Type ) {
      ...
      case 42: {
        ...
        b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       -(int)WorldTime % 200'000 * 0.00001f );
      }
        return true;
      case 43: {
        vec3_t Light;
        ...
        Vector( 1.0f, 1.0f, 1.0f, b->BodyLight );
        b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       -0.1f + (int)WorldTime % 5'000 * 0.0001f, BITMAP_KANTURU3RD_OBJECT );
  ...
  if ( IsInKanturu3rd() ) {
    switch ( o->Type ) {
      ...
      case 73: {
        if ( !KanturuSuccessMap ) {
          b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
                         (int)WorldTime % 10'000 * 0.0002f );
          b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight,
                         (int)WorldTime % 10'000 * 0.0002f, o->BlendMeshTexCoordV );
        }
      } break;
      case MODEL_STORM3: {
        VectorCopy( o->Light, b->BodyLight );
      ...
      case MODEL_MAYAHANDSKILL: {
        ...
        b->RenderMesh( 1, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 1, o->BlendMeshLight,
                       -(int)WorldTime % 2'000 * 0.001f, o->BlendMeshTexCoordV );
      } break;
    }
  }
}
      ...
      if ( o->CurrentAction == MONSTER01_ATTACK3 ) {
        ...
        for ( int i = 0; i < 2; i++ ) {
          ...
          CreateJoint( BITMAP_FLARE, Position, Position, Angle, 2, NULL, 40 );
                  ...
                  ( o->AnimationFrame >= 5.2f && o->AnimationFrame <= 5.8f ) ) {
        float Matrix[3][4];
...
bool M39Kanturu3rd::RenderKanturu3rdMonsterObjectMesh( OBJECT* o, BMD* b, bool ExtraMon )
{
  switch ( o->Type ) {
    ...
    case MODEL_MAYA_HAND_LEFT: {
      ...
      b->RenderMesh( 2, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV );
      b->RenderMesh( 2, RENDER_BRIGHT | RENDER_CHROME, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
...
void M39Kanturu3rd::MayaAction( OBJECT* o, BMD* b )
{
  ...
  switch ( iMayaAction ) {
    ...
    case 1: {
      if ( bMayaSkill2 ) {
        if ( iMayaSkill2_Counter == 0 || g_Time.GetTimeCheck( 0, 1'000 ) ) {
          for ( int i = 0; i < 10; i++ ) {
    ...
    case 2: {
      if ( g_Direction.m_CKanturu.GetMayaExplotion() ) {
        ...
        if ( iMayaDie_Counter == 0 ) {
          ...
          if ( g_Time.GetTimeCheck( 1, 1'200 ) ) {
            iMayaDie_Counter++;
          }
          ...
          if ( g_Time.GetTimeCheck( 2, 1'200 ) ) {
            iMayaDie_Counter++;
          }
        }
      }
...
void M39Kanturu3rd::Kanturu3rdSuccess()
{
  ...
  if ( fAlpha <= 1.0f ) {
    fAlpha += 0.01f;
  } else if ( fAlpha >= 0.99f && g_Time.GetTimeCheck( 3, 5'000 ) ) {
    fAlpha         = 0.1f;
    iKanturuResult = -1;
  }
...
void M39Kanturu3rd::Kanturu3rdFailed()
{
  ...
  if ( fAlpha <= 1.0f ) {
    fAlpha += 0.01f;
  } else if ( fAlpha >= 0.99f && g_Time.GetTimeCheck( 4, 5'000 ) ) {
    fAlpha         = 0.1f;
    iKanturuResult = -1;
  }
