...
constexpr std::array<MonsterDefinition, 12> kMonsterDefinitions{
  {
   ...
   { MONSTER_BLOOD_ASSASSIN, EMonsterModelType::MONSTER_MODEL_BLOOD_ASSASSIN, MODEL_BLOOD_ASSASSIN, 1.0f, true,
        100 },
      ...
      switch ( o->Type ) {
        ...
        case MODEL_BURNING_LAVA_GIANT: {
          ...
          if ( fBlendMeshLight < 0 ) {
            ...
            b->RenderMesh( 0, RENDER_TEXTURE, fAlpha, 0, fBlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV,
                           iTexture );
          } else {
            for ( int i = 0; i < 3; ++i ) {
