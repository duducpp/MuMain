...
void CursedTemple::UpdateTempleSystemMsg( int _Value )
{
  ...
  swprintf( szText, GlobalText[2'367] );
  switch ( _Value ) {
    case 0:
      break;
    case 1:
    ...
    case 3:
      ...
      break;
    case 4:
      g_pSystemLogBox->AddText( GlobalText[2'368], SEASON3B::TYPE_ERROR_MESSAGE );
      break;
    case 5:
    ...
    case 6:
      break;
    case 7:
      g_pSystemLogBox->AddText( GlobalText[2'865], SEASON3B::TYPE_ERROR_MESSAGE );
      break;
    case 8:
      g_pSystemLogBox->AddText( GlobalText[2'175], SEASON3B::TYPE_ERROR_MESSAGE );
      break;
  }
}
...
bool CursedTemple::RenderObjectMesh( OBJECT* o, BMD* b, bool ExtraMon )
{
  ...
  switch ( o->Type ) {
    ...
    case 54: {
      ...
      b->RenderBody( RENDER_TEXTURE, o->Alpha, o->BlendMesh, fLumi + 0.3f, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV,
                     2 );
      b->RenderMesh( 2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                     o->BlendMeshTexCoordU, o->BlendMeshTexCoordV );
    }
