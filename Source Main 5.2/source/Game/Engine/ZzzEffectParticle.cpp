      ...
      switch ( o->Type ) {
        ...
        case BITMAP_CLUD64: {
          ...
          } else if ( o->SubType == 6 ) // ◎
          {
            ...
            o->Scale +=
                ( ( float( ( rand() % 20 ) - 10 ) / 2.0f ) * ( ( fIntervalScale / 2.f ) ) ) * FPS_ANIMATION_FACTOR;
            o->Rotation    = (float)( rand() % 360 );
...
void MoveParticles()
{
  ...
  for ( int i = 0; i < 2; ++i ) {
    g_vParticleWindVelo[i] += ( rand() % 2'001 - 1'000 ) * ( 0.001f * 0.6f );
    ...
    if ( o->Live ) {
      ...
      switch ( o->Type ) {
        ...
        case BITMAP_LIGHTNING + 1: {
          ...
          o->Rotation   = (float)( (int)WorldTime % 1'000 ) * 0.001f;
        ...
        case BITMAP_FIRE_HIK2_MONO:
          if ( o->SubType == 0 ) {
            ...
            Luminosity = o->Alpha;
            Vector( o->TurningForce[0] * Luminosity, o->TurningForce[1] * Luminosity, o->TurningForce[2] * Luminosity,
                    o->Light );
            if ( o->Scale > 0 ) {
        ...
        case BITMAP_SMOKE:
          switch ( o->SubType ) {
            ...
            case 14:
              ...
              Vector( Luminosity * o->TurningForce[0], Luminosity * o->TurningForce[1], Luminosity * o->TurningForce[2],
                      o->Light );
              VectorScale( o->Velocity, 0.4f, o->Velocity );
              o->Scale += FPS_ANIMATION_FACTOR * 0.05f;
            ...
            case 6:
              ...
              o->Scale = sinf( ( (int)( o->Gravity + WorldTime ) % 1'800 * 0.1f * ( Q_PI / 180.f ) ) ) * 0.5f + 1.8f;
            ...
            case 26:
              Luminosity = (float)( o->LifeTime ) / 20.f;
              Vector( o->Light[0] * Luminosity * 1.f, o->Light[1] * Luminosity * 1.f, o->Light[2] * Luminosity * 1.f,
                      o->Light );
            ...
            case 42:
              Luminosity = (float)( o->LifeTime ) / 8.f;
              Vector( Luminosity * 127.f / 255.f, Luminosity * 255.f / 255.f, Luminosity * 200.f / 255.f, o->Light );
              o->Gravity += ( 0.2f ) * FPS_ANIMATION_FACTOR;
              o->Position[2] += o->Gravity * FPS_ANIMATION_FACTOR;
              o->Scale += FPS_ANIMATION_FACTOR * 0.05f;
              break;
        ...
        case BITMAP_SMOKE + 4:
          ...
          if ( o->SubType == 6 ) {
            ...
            o->Position[2] =
                RequestTerrainHeight( o->Position[0], o->Position[1] ) + Bitmaps[o->Type].Height * o->Scale * 0.5f;
          }
          break;
        ...
        case BITMAP_LIGHT:
          if ( 0 == o->SubType || 2 == o->SubType || o->SubType == 7 || o->SubType == 8 ) {
            ...
            if ( o->SubType == 7 ) {
              ...
              vRandom[0] = ( (float)( rand() % 2'001 - 1'000 ) ) * ( 0.001f * 0.4f ) * FPS_ANIMATION_FACTOR;
              vRandom[1] = ( (float)( rand() % 2'001 - 1'000 ) ) * ( 0.001f * 0.4f ) * FPS_ANIMATION_FACTOR;
              vRandom[2] = 0.f;
        ...
        case BITMAP_RAKLION_CLOUDS: {
          ...
          if ( rand_fps_check( 10 ) ) {
            ...
            fRand1 = (float)( ( rand() % 2'000 ) - 1'000 ) * 0.001f;
            fRand2 = (float)( ( rand() % 2'000 ) - 1'000 ) * 0.001f;
            fRand3 = (float)( ( rand() % 2'000 ) - 1'000 ) * 0.001f;
    ...
    if ( o->Live ) {
      ...
      switch ( o->Type ) {
        ...
        case BITMAP_EXPLOTION:
          ...
          break;
        case BITMAP_EXPLOTION + 1:
          RenderSprite( o->TexType, o->Position, Width * 0.25f, Height, o->Light, o->Angle[0], o->Frame % 4 * 0.25f,
                        0.f, 0.25f, 1.f );
          break;
        case BITMAP_SUMMON_SAHAMUTT_EXPLOSION:
          RenderSprite( o->TexType, o->Position, Width, Height, o->Light, 0.f, o->Frame % 4 * 0.25f + 0.005f,
        ...
        case BITMAP_LIGHTNING:
          ...
          break;
        case BITMAP_BLOOD + 1:
          RenderSprite( o->TexType, o->Position, Width, Height, o->Light, 0.f, o->Frame % 2 * 0.5f, o->Frame / 2 * 0.5f,
                        0.5f, 0.5f );
          break;
        case BITMAP_CHROME_ENERGY2:
          RenderSprite( o->TexType, o->Position, Width * 0.25f, Height, o->Light, o->Rotation, o->Frame % 4 * 0.25f,
                        0.f, 0.25f, 1.f );
          break;
        case BITMAP_FIRE_CURSEDLICH:
        case BITMAP_FIRE_HIK2_MONO:
        ...
        case BITMAP_SBUMB: {
          RenderSprite( o->TexType, o->Position, Width * 0.25f, Height, o->Light, 0.0f, o->Frame % 4 * 0.25f + 0.005f,
                        0.0f, 0.25f - 0.01f, 1.0f );
        } break;
        case BITMAP_DAMAGE1: {
