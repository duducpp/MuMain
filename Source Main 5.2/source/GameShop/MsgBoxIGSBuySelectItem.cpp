...
void CMsgBoxIGSBuySelectItem::RenderTexts()
{
  ...
  g_pRenderText->RenderText( GetPos().x, GetPos().y + IGS_TEXT_TITLE_POS_Y, GlobalText[2'890], IMAGE_IGS_FRAME_WIDTH, 0,
                             RT3_SORT_CENTER );
...
void CMsgBoxIGSBuySelectItem::SetButtonInfo()
{
  ...
  m_BtnBuy.SetText( GlobalText[2'891] );
  ...
  m_BtnPresent.SetText( GlobalText[2'892] );
                                       ...
                                       wchar_t* pszPriceUnit, int iCashType )
{
  ...
  g_InGameShopSystem->GetProductInfoFromPriceSeq( iProductSeq, iPriceSeq, CInGameShopSystem::IGS_PRODUCT_ATT_TYPE_PRICE,
                                                  iValue, szText );
  ...
  g_InGameShopSystem->GetProductInfoFromPriceSeq( iProductSeq, iPriceSeq, CInGameShopSystem::IGS_PRODUCT_ATT_TYPE_NUM,
                                                  iValue, szText );
  if ( iValue > 0 ) {
    swprintf( Item.m_szAttribute, GlobalText[3'045], iValue, Item.m_szItemPeriod );
  } else {
    swprintf( Item.m_szAttribute, GlobalText[3'039], Item.m_szItemPeriod );
  }
