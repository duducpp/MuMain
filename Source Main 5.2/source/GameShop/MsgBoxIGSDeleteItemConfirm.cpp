...
void CMsgBoxIGSDeleteItemConfirm::Initialize( int iStorageSeq, int iStorageItemSeq, wchar_t szItemType )
{
  ...
  m_iDesciptionLine = ::DivideStringByPixel( &m_szDescription[0][0], UIMAX_TEXT_LINE, MAX_TEXT_LENGTH,
                                             GlobalText[2'931], IGS_TEXT_DIVIDE_WIDTH, false, '#' );
}
...
void CMsgBoxIGSDeleteItemConfirm::SetButtonInfo()
{
  ...
  m_BtnDelete.SetText( GlobalText[2'932] );
...
void CMsgBoxIGSDeleteItemConfirm::RenderTexts()
{
  ...
  // Title - "������ ����"
  g_pRenderText->RenderText( GetPos().x, GetPos().y + IGS_TEXT_TITLE_Y, GlobalText[2'930], IMAGE_IGS_FRAME_WIDTH, 0,
                             RT3_SORT_CENTER );
