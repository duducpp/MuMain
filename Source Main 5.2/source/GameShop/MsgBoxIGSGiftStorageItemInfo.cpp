...
void CMsgBoxIGSGiftStorageItemInfo::Initialize( int iStorageSeq, int iStorageItemSeq, WORD wItemCode,
                                                wchar_t szItemType, wchar_t* pszID, wchar_t* pszMessage,
                                                wchar_t* pszName, wchar_t* pszNum, wchar_t* pszPeriod )
{
  ...
  // Num
  swprintf( m_szNum, GlobalText[3'040], pszNum ); // "���� : %ls"

  // Period
  swprintf( m_szPeriod, GlobalText[3'039], pszPeriod ); // "�Ⱓ : %ls"

  // ID Info
  // "\'%ls\' ���� ���� �����Դϴ�."
  swprintf( m_szIDInfo, GlobalText[3'041], pszID );
...
void CMsgBoxIGSGiftStorageItemInfo::RenderTexts()
{
  ...
  // Title "���� ����â"
  g_pRenderText->RenderText( GetPos().x, GetPos().y + IGS_TEXT_TITLE_POS_Y, GlobalText[3'048], IMAGE_IGS_FRAME_WIDTH, 0,
                             RT3_SORT_CENTER );
