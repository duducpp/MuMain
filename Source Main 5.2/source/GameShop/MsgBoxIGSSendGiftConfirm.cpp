...
void CMsgBoxIGSSendGiftConfirm::RenderTexts()
{
  ...
  g_pRenderText->RenderText( GetPos().x, GetPos().y + IGS_TEXT_TITLE_POS_Y, GlobalText[2'907], IMAGE_IGS_FRAME_WIDTH, 0,
                             RT3_SORT_CENTER );

  g_pRenderText->SetFont( g_hFont );

  g_pRenderText->RenderText( GetPos().x, GetPos().y + IGS_TEXT_QUESTION_POS_Y, GlobalText[2'908], IMAGE_IGS_FRAME_WIDTH,
                             0, RT3_SORT_CENTER );
