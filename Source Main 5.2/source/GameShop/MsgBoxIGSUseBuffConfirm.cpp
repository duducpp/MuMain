                                           ...
                                           wchar_t* pszItemName, wchar_t* pszBuffName )
{
  ...
  swprintf( szText, GlobalText[3'047], pszItemName, pszBuffName, pszItemName );
...
void CMsgBoxIGSUseBuffConfirm::RenderTexts()
{
  ...
  g_pRenderText->RenderText( GetPos().x, GetPos().y + IGS_TEXT_TITLE_Y, GlobalText[3'046], IMAGE_IGS_FRAME_WIDTH, 0,
                             RT3_SORT_CENTER );
