...
void CListManager::SetListManagerInfo( DownloaderType type, wchar_t* ServerIP, wchar_t* UserID, wchar_t* Pwd,
                                       wchar_t* RemotePath, wchar_t* LocalPath, CListVersionInfo Version,
...
void CListManager::SetListManagerInfo( DownloaderType type, wchar_t* ServerIP, unsigned short PortNum, wchar_t* UserID,
                                       wchar_t* Pwd, wchar_t* RemotePath, wchar_t* LocalPath, FTP_SERVICE_MODE ftpMode,
...
bool CListManager::IsScriptFileExist() // OK
{
  ...
  for ( std::vector<std::wstring>::iterator it = this->m_vScriptFiles.begin(); it != this->m_vScriptFiles.end();
        it++ ) {
