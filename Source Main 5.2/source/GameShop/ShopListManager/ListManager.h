...
public:
  ...
  //				�� ����Ʈ �ٿ�ε� & ���� �� ���� ������ �����Ѵ�.
  void SetListManagerInfo( DownloaderType type, wchar_t* ServerIP, wchar_t* UserID, wchar_t* Pwd, wchar_t* RemotePath,
                           wchar_t* LocalPath, CListVersionInfo Version, DWORD dwDownloadMaxTime = 0 );

  void SetListManagerInfo( DownloaderType type, wchar_t* ServerIP, unsigned short PortNum, wchar_t* UserID,
