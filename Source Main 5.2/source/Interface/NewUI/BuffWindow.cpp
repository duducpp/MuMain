...
void SEASON3B::CNewUIBuffWindow::RenderBuffTooltip( eBuffClass& eBuffClassType, eBuffState& eBuffType, float x,
                                                    float y )
{
  int TextNum = 0;
  ...
  if ( bufftime.size() != 0 ) {
    swprintf( TextList[TextNum], GlobalText[2'533], bufftime.c_str() );
