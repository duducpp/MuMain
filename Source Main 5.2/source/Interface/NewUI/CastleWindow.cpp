...
#include "MixMgr.h"
#include "Interface/UI/UISenatus.h"
...
bool CNewUICastleWindow::Create( CNewUIManager* pNewUIMng, int x, int y )
{
  ...
  ltext.push_back( GlobalText[1'589] );
  ltext.push_back( GlobalText[1'590] );
  ltext.push_back( GlobalText[1'591] );
  ltext.push_back( GlobalText[1'640] );
  ...
  m_BtnExit.ChangeToolTipText( GlobalText[1'002], true );

  InitButton( &m_BtnBuy, m_Pos.x + INVENTORY_WIDTH / 2 - 27, m_Pos.y + 250, GlobalText[1'558] );
  InitButton( &m_BtnRepair, m_Pos.x + 110, m_Pos.y + 260, GlobalText[1'559] );
  InitButton( &m_BtnUpgradeHP, m_Pos.x + 110, m_Pos.y + 310, GlobalText[1'550] );
  InitButton( &m_BtnUpgradeDefense, m_Pos.x + 110, m_Pos.y + 334, GlobalText[1'550] );
  InitButton( &m_BtnUpgradeRecover, m_Pos.x + 110, m_Pos.y + 358, GlobalText[1'550] );
  InitButton( &m_BtnApplyTax, m_Pos.x + 120, m_Pos.y + 133, GlobalText[1'106] );
...
void CNewUICastleWindow::RenderFrame()
{
  ...
  swprintf( szText, L"%ls", GlobalText[1'588] );
...
void CNewUICastleWindow::UpdateGateManagingTab()
{
  ...
  if ( m_BtnBuy.UpdateMouseEvent() == true ) {
    ...
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    pMsgBox->AddMsg( GlobalText[1'555] );

    if ( g_SenatusInfo.GetHPLevel( &g_SenatusInfo.GetCurrGateInfo() ) == 0 ) {
      swprintf( szText, GlobalText[1'553], 2, 1'000'000 );
    } else if ( g_SenatusInfo.GetHPLevel( &g_SenatusInfo.GetCurrGateInfo() ) == 1 ) {
      swprintf( szText, GlobalText[1'553], 3, 1'000'000 );
    } else {
      swprintf( szText, GlobalText[1'553], 4, 1'000'000 );
    }
    InsertComma( szText, 1'000'000 );
    pMsgBox->AddMsg( szText );
    pMsgBox->AddMsg( GlobalText[1'554] );
  } else if ( m_BtnUpgradeDefense.UpdateMouseEvent() == true ) {
    SetCurrMsgBoxRequest( CASTLE_MSGREQ_UPGRADE_GATE_DEFENSE );
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    pMsgBox->AddMsg( GlobalText[1'556] );
    if ( g_SenatusInfo.GetDefenseLevel( &g_SenatusInfo.GetCurrGateInfo() ) == 0 ) {
      swprintf( szText, GlobalText[1'553], 2, 3'000'000 );
    } else if ( g_SenatusInfo.GetDefenseLevel( &g_SenatusInfo.GetCurrGateInfo() ) == 1 ) {
      swprintf( szText, GlobalText[1'553], 3, 3'000'000 );
    } else {
      swprintf( szText, GlobalText[1'553], 4, 3'000'000 );
    }
    InsertComma( szText, 3'000'000 );
    pMsgBox->AddMsg( szText );
    pMsgBox->AddMsg( GlobalText[1'554] );
  }
}
...
void CNewUICastleWindow::UpdateStatueManagingTab()
{
  ...
  if ( m_BtnBuy.UpdateMouseEvent() == true ) {
    ...
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    pMsgBox->AddMsg( GlobalText[1'610] );
    swprintf( szText, GlobalText[1'617], g_SenatusInfo.GetRepairCost( &g_SenatusInfo.GetCurrStatueInfo() ) );
    ...
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    pMsgBox->AddMsg( GlobalText[1'611] );
    swprintf( szText, GlobalText[1'617], g_SenatusInfo.GetRepairCost( &g_SenatusInfo.GetCurrStatueInfo() ) );
    InsertComma( szText, g_SenatusInfo.GetRepairCost( &g_SenatusInfo.GetCurrStatueInfo() ) );
    pMsgBox->AddMsg( szText );
    pMsgBox->AddMsg( GlobalText[1'554] );
    ...
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    pMsgBox->AddMsg( GlobalText[1'613] );
    ...
    if ( g_SenatusInfo.GetHPLevel( &g_SenatusInfo.GetCurrStatueInfo() ) == 0 ) {
      ...
      swprintf( szText, GlobalText[1'553], 5, 1'000'000 );
    } else {
      swprintf( szText, GlobalText[1'553], 7, 1'000'000 );
    }
    InsertComma( szText, 1'000'000 );
    pMsgBox->AddMsg( szText );
    pMsgBox->AddMsg( GlobalText[1'554] );
    ...
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    pMsgBox->AddMsg( GlobalText[1'614] );
    ...
    if ( g_SenatusInfo.GetDefenseLevel( &g_SenatusInfo.GetCurrStatueInfo() ) == 0 ) {
      ...
      swprintf( szText, GlobalText[1'553], 5, 3'000'000 );
    } else {
      swprintf( szText, GlobalText[1'553], 7, 3'000'000 );
    }
    InsertComma( szText, 3'000'000 );
    pMsgBox->AddMsg( szText );
    pMsgBox->AddMsg( GlobalText[1'554] );
    ...
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    pMsgBox->AddMsg( GlobalText[1'615] );

    if ( g_SenatusInfo.GetRecoverLevel( &g_SenatusInfo.GetCurrStatueInfo() ) == 0 ) {
      swprintf( szText, GlobalText[1'553], 3, 5'000'000 );
    } else if ( g_SenatusInfo.GetRecoverLevel( &g_SenatusInfo.GetCurrStatueInfo() ) == 1 ) {
      swprintf( szText, GlobalText[1'553], 5, 5'000'000 );
    } else {
      swprintf( szText, GlobalText[1'553], 7, 5'000'000 );
    }
    InsertComma( szText, 5'000'000 );
    pMsgBox->AddMsg( szText );
    pMsgBox->AddMsg( GlobalText[1'554] );
  }
}
...
void CNewUICastleWindow::UpdateTaxManagingTab()
{
  ...
  if ( m_BtnApplyTax.UpdateMouseEvent() == true ) {
    ...
    SEASON3B::CreateMessageBox( MSGBOX_LAYOUT_CLASS( SEASON3B::CCastleMsgBoxLayout ), &pMsgBox );
    swprintf( szText, GlobalText[1'566], g_SenatusInfo.GetChaosTaxRate() );
    pMsgBox->AddMsg( szText );
    swprintf( szText, GlobalText[1'567], g_SenatusInfo.GetNormalTaxRate() );
    pMsgBox->AddMsg( szText );
    pMsgBox->AddMsg( GlobalText[1'568] );
...
void CNewUICastleWindow::RenderGateManagingTab()
{
  ...
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'557], 190, 0, RT3_SORT_CENTER );
  ...
  if ( pNPCInfo->btNpcLive == 0 ) {
    ...
    wchar_t szTemp[256];
    swprintf( szTemp, GlobalText[1'560], pNPCInfo->iNpcHp, pNPCInfo->iNpcMaxHp );
    ...
    ptOrigin.y += 13;
    swprintf( szTemp, GlobalText[1'561], g_SenatusInfo.GetDefense( pNPCInfo->iNpcNumber, pNPCInfo->iNpcDfLevel ) );
    g_pRenderText->RenderText( ptOrigin.x + 20, ptOrigin.y, szTemp );
    ...
    g_pRenderText->SetFont( g_hFontBold );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'550], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->SetFont( g_hFont );

    ptOrigin.y += 24;
    swprintf( szTemp, GlobalText[1'563], g_SenatusInfo.GetNextAddHP( pNPCInfo ) );
    InsertComma( szTemp, g_SenatusInfo.GetNextAddHP( pNPCInfo ) );
    g_pRenderText->RenderText( ptOrigin.x + 30, ptOrigin.y, szTemp );
    ptOrigin.y += 23;
    swprintf( szTemp, GlobalText[1'564], g_SenatusInfo.GetNextAddDefense( pNPCInfo ) );
...
void CNewUICastleWindow::RenderStatueManagingTab()
{
  ...
  if ( pNPCInfo->btNpcLive == 0 ) {
    ...
    g_pRenderText->RenderText( ptOrigin.x + 20, ptOrigin.y, szTemp );
    ptOrigin.y += 13;
    swprintf( szTemp, GlobalText[1'562], g_SenatusInfo.GetRecover( pNPCInfo->iNpcNumber, pNPCInfo->iNpcRgLevel ) );
    g_pRenderText->RenderText( ptOrigin.x + 20, ptOrigin.y, szTemp );
    ...
    g_pRenderText->RenderText( ptOrigin.x + 30, ptOrigin.y, szTemp );
    ptOrigin.y += 23;
    swprintf( szTemp, GlobalText[1'565], g_SenatusInfo.GetNextAddRecover( pNPCInfo ) );
...
void CNewUICastleWindow::RenderTaxManagingTab()
{
  ...
  g_pRenderText->SetFont( g_hFontBold );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'572], 190, 0, RT3_SORT_CENTER );
  ...
  swprintf( szTemp, GlobalText[1'573], g_SenatusInfo.GetRealTaxRateChaos(), g_SenatusInfo.GetChaosTaxRate() );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, szTemp, 175, 0, RT3_SORT_CENTER );
  ptOrigin.y += 25;

  swprintf( szTemp, GlobalText[1'574], g_SenatusInfo.GetRealTaxRateStore(), g_SenatusInfo.GetNormalTaxRate() );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, szTemp, 175, 0, RT3_SORT_CENTER );

  m_BtnApplyTax.Render();

  ptOrigin.y += 53;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'575], 160, 0, RT3_SORT_CENTER );
  ptOrigin.y += 13;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'576], 160, 0, RT3_SORT_CENTER );
  ptOrigin.y += 13;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'577], 160, 0, RT3_SORT_CENTER );

  g_pRenderText->SetFont( g_hFontBold );
  g_pRenderText->SetTextColor( 0xFF947BBB );

  ptOrigin.y += 20;
  swprintf( szTemp, GlobalText[1'578] );
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, szTemp, 160, 0, RT3_SORT_CENTER );

  ptOrigin.y += 12;
  swprintf( szTemp, GlobalText[1'579] );
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, szTemp, 160, 0, RT3_SORT_CENTER );

  ptOrigin.y += 12;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'580], 160, 0, RT3_SORT_CENTER );
  ptOrigin.y += 12;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'581], 160, 0, RT3_SORT_CENTER );
  ptOrigin.y += 12;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'582], 160, 0, RT3_SORT_CENTER );
  ptOrigin.y += 12;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'583], 160, 0, RT3_SORT_CENTER );
  ...
  swprintf( szTemp, GlobalText[1'246] );
  ...
  ptOrigin.y += 54;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'585], 160, 0, RT3_SORT_CENTER );
  ptOrigin.y += 12;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'586], 160, 0, RT3_SORT_CENTER );
  ptOrigin.y += 12;
  g_pRenderText->RenderText( ptOrigin.x + 15, ptOrigin.y, GlobalText[1'587], 160, 0, RT3_SORT_CENTER );
}
