...
bool SEASON3B::CNewUICryWolf::Render()
{
  ...
  if ( Suc_Or_Fail >= 0 ) {
    ...
    if ( ( Delay * 15 ) > 479 ) {
      ...
      // Delay_Add_inter
      g_pCryWolfInterface->Render( -329 + ( Delay * 15 ), 50, 329, 94, 0.f, 0.f, 328.f / 512.f, 93.f / 128.f, Add_Num,
                                   false, false, A_Value );
    }
  ...
  if ( m_bTimeStart == true && m_CrywolfState == CRYWOLF_STATE_START ) {
    ...
    if ( m_iSecond / 1'000 < 10 ) {
      RenderNumber2D( 520 + 77, 384 + 18, 0, 14, 14 );
    }
    RenderNumber2D( 520 + 87, 384 + 18, m_iSecond / 1'000, 14, 14 );
