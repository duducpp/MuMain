...
#include "Interface/UI/UIGateKeeper.h"
...
bool CNewUIGatemanWindow::Create( CNewUIManager* pNewUIMng, int x, int y )
{
  ...
  InitButton( &m_BtnEnter, m_Pos.x + INVENTORY_WIDTH / 2 - 27, m_Pos.y + 320, GlobalText[1'593] );
  InitButton( &m_BtnSet, m_Pos.x + INVENTORY_WIDTH / 2 - 27, m_Pos.y + 220, GlobalText[1'619] );
...
void CNewUIGatemanWindow::RenderFrame()
{
  ...
  swprintf( szText, L"%ls", GlobalText[1'596] );
...
void CNewUIGatemanWindow::RenderGuildMasterMode()
{
  POINT ptOrigin = { m_Pos.x, m_Pos.y + 50 };
  g_pRenderText->SetFont( g_hFontBold );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'597], 190, 0, RT3_SORT_CENTER );
  g_pRenderText->SetFont( g_hFont );
  ptOrigin.y += 20;
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'624], 190, 0, RT3_SORT_CENTER );
  ptOrigin.y += 10;
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'625], 190, 0, RT3_SORT_CENTER );
  ptOrigin.y += 10;
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'626], 190, 0, RT3_SORT_CENTER );
  ptOrigin.y += 20;

  RenderCheckBox( ptOrigin.x + 35, ptOrigin.y, g_pUIGateKeeper->IsPublic() );
  g_pRenderText->RenderText( ptOrigin.x + 55, ptOrigin.y, GlobalText[1'598] );
  wchar_t szText[256];
  wchar_t szGold[64];
  ptOrigin.y += 18;
  ConvertGold( g_pUIGateKeeper->GetEnteranceFee(), szGold );
  swprintf( szText, GlobalText[1'602], szGold );
  ...
  g_pRenderText->SetFont( g_hFontBold );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'599], 190, 0, RT3_SORT_CENTER );
  ...
  swprintf( szText, GlobalText[1'600], szGold );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, szText, 190, 0, RT3_SORT_CENTER );

  ptOrigin.y += 13;
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'601], 190, 0, RT3_SORT_CENTER );

  ptOrigin.y += 13;
  ConvertGold( g_pUIGateKeeper->GetAddEnteranceFee(), szGold );
  swprintf( szText, GlobalText[1'618], szGold );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, szText, 190, 0, RT3_SORT_CENTER );
...
{
  POINT ptOrigin = { m_Pos.x, m_Pos.y + 50 };
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'634], 190, 0, RT3_SORT_CENTER );
...
void CNewUIGatemanWindow::RenderGuestMode()
{
  ...
  if ( g_pUIGateKeeper->IsPublic() ) {
    ...
    wchar_t szGold[64];
    ConvertGold( g_pUIGateKeeper->GetEnteranceFee(), szGold );
    swprintf( szText, GlobalText[1'632], szGold );
    ...
    g_pRenderText->SetTextColor( 0xFFFFFFFF );
    g_pRenderText->SetBgColor( 0x00000000 );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'633], 190, 0, RT3_SORT_CENTER );
    ...
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'627], 190, 0, RT3_SORT_CENTER );
    ptOrigin.y += 10;
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'629], 190, 0, RT3_SORT_CENTER );
    ptOrigin.y += 10;
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'630], 190, 0, RT3_SORT_CENTER );
    ptOrigin.y += 10;
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y, GlobalText[1'631], 190, 0, RT3_SORT_CENTER );
    ptOrigin.y += 10;
