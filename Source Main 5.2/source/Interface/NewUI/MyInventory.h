...
#include "Interface/NewUI/Base.h"
#include "Interface/NewUI/InventoryCtrl.h"
#include "Interface/NewUI/MessageBox.h"
#include "Interface/NewUI/3DRenderMng.h"
#include "Interface/NewUI/Button.h"
#include "span.hpp"
#include "_enum.h"
...
public:
  enum IMAGE_LIST
  {
    ...
    IMAGE_INVENTORY_BACK_TOP         = BITMAP_INTERFACE_NEW_PERSONALINVENTORY_BEGIN, //"NewUI/_item_back01.tga"
    IMAGE_INVENTORY_BACK_TOP2,                                                       //"NewUI/_item_back04.tga"
    IMAGE_INVENTORY_BACK_LEFT,                                                       //"NewUI/_item_back02-L.tga"
    IMAGE_INVENTORY_BACK_RIGHT,                                                      //"NewUI/_item_back02-R.tga"
    IMAGE_INVENTORY_BACK_BOTTOM,                                                     //"NewUI/_item_back03.tga"
    IMAGE_INVENTORY_ITEM_BOOT,                                                       //"NewUI/_item_boots.tga"
    IMAGE_INVENTORY_ITEM_HELM,                                                       //"NewUI/_item_cap.tga"
    IMAGE_INVENTORY_ITEM_FAIRY,                                                      //"NewUI/_item_fairy.tga"
    IMAGE_INVENTORY_ITEM_WING,                                                       //"NewUI/_item_wing.tga"
    IMAGE_INVENTORY_ITEM_RIGHT,                                                      //"NewUI/_item_weapon(L).tga"
    IMAGE_INVENTORY_ITEM_LEFT,                                                       //"NewUI/_item_weapon(R).tga"
    IMAGE_INVENTORY_ITEM_ARMOR,                                                      //"NewUI/_item_upper.tga"
    IMAGE_INVENTORY_ITEM_GLOVES,                                                     //"NewUI/_item_gloves.tga"
    IMAGE_INVENTORY_ITEM_PANTS,                                                      //"NewUI/_item_lower.tga"
    IMAGE_INVENTORY_ITEM_RING,                                                       //"NewUI/_item_ring.tga"
    IMAGE_INVENTORY_ITEM_NECKLACE,                                                   //"NewUI/_item_necklace.tga"
    IMAGE_INVENTORY_MONEY,                                                           //"NewUI/_item_money.tga"
    IMAGE_INVENTORY_EXIT_BTN,                                                        //"NewUI/_exit_00.tga"
    IMAGE_INVENTORY_REPAIR_BTN,                                                      //"NewUI/_repair_00.tga"
    IMAGE_INVENTORY_EXPAND_BTN,                                                      //"NewUI/_expansion_btn.tga"
  };
