...
void SEASON3B::CNewUIMyQuestInfoWindow::RenderTempleInfo()
{
  ...
  g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 285, GlobalText[2'369], 190, 0, RT3_SORT_CENTER );
...
void SEASON3B::CNewUIMyQuestInfoWindow::SetButtonInfo()
{
  ...
  m_btnQuestOpen.ChangeButtonInfo( m_Pos.x + 50, m_Pos.y + 392, 36, 29 );
  m_btnQuestOpen.ChangeToolTipText( GlobalText[2'822], true );

  m_btnQuestGiveUp.ChangeButtonImgState( true, IMAGE_MYQUEST_BTN_GIVE_UP, false );
  m_btnQuestGiveUp.ChangeButtonInfo( m_Pos.x + 87, m_Pos.y + 392, 36, 29 );
  m_btnQuestGiveUp.ChangeToolTipText( GlobalText[2'823], true );
}
...
void CNewUIMyQuestInfoWindow::RenderTabBtn()
{
  ...
  if ( m_eTabBtnIndex == TAB_QUEST ) {
    ...
    g_pRenderText->SetTextColor( 255, 255, 255, 255 );
    g_pRenderText->RenderText( m_Pos.x + 10, m_Pos.y + 34, GlobalText[1'140], 48, 0, RT3_SORT_CENTER );
    g_pRenderText->SetTextColor( 181, 181, 181, 181 );
    g_pRenderText->RenderText( m_Pos.x + 57, m_Pos.y + 35, GlobalText[2'821], 48, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( m_Pos.x + 104, m_Pos.y + 35, GlobalText[2'824], 72, 0, RT3_SORT_CENTER );
  } else if ( m_eTabBtnIndex == TAB_JOB_CHANGE ) {
    RenderImage( IMAGE_MYQUEST_TAB_SMALL, m_Pos.x + 57, m_Pos.y + 27, 48.f, 22.f );
    g_pRenderText->SetTextColor( 255, 255, 255, 255 );
    g_pRenderText->RenderText( m_Pos.x + 57, m_Pos.y + 34, GlobalText[2'821], 48, 0, RT3_SORT_CENTER );
    g_pRenderText->SetTextColor( 181, 181, 181, 181 );
    g_pRenderText->RenderText( m_Pos.x + 10, m_Pos.y + 35, GlobalText[1'140], 48, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( m_Pos.x + 104, m_Pos.y + 35, GlobalText[2'824], 72, 0, RT3_SORT_CENTER );
  } else if ( m_eTabBtnIndex == TAB_CASTLE_TEMPLE ) {
    RenderImage( IMAGE_MYQUEST_TAB_BIG, m_Pos.x + 104, m_Pos.y + 27, 72.f, 22.f );
    g_pRenderText->SetTextColor( 255, 255, 255, 255 );
    g_pRenderText->RenderText( m_Pos.x + 104, m_Pos.y + 34, GlobalText[2'824], 72, 0, RT3_SORT_CENTER );
    g_pRenderText->SetTextColor( 181, 181, 181, 181 );
    g_pRenderText->RenderText( m_Pos.x + 10, m_Pos.y + 35, GlobalText[1'140], 48, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( m_Pos.x + 57, m_Pos.y + 35, GlobalText[2'821], 48, 0, RT3_SORT_CENTER );
  }
