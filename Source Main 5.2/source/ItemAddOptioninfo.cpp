...
void ItemAddOptioninfo::GetItemAddOtioninfoText( std::vector<std::wstring>& outtextlist, int type )
{
  ...
  for ( int i = 0; i < 2; ++i ) {
    ...
    switch ( optiontype ) {
      case 1:
        swprintf( TempText, GlobalText[2'184], optionvalue );
        break;
      case 2:
        swprintf( TempText, GlobalText[2'185], optionvalue );
        break;
      case 3:
        swprintf( TempText, GlobalText[2'186], optionvalue );
        break;
      case 4:
        swprintf( TempText, GlobalText[2'187], optionvalue );
        break;
      case 5:
        swprintf( TempText, GlobalText[2'188], optionvalue );
        break;
      case 6:
        swprintf( TempText, GlobalText[2'189], optionvalue );
        break;
      case 7:
        swprintf( TempText, GlobalText[2'190] );
        break;
      case 8:
        swprintf( TempText, GlobalText[2'191], optionvalue );
        break;
    }
