...
{
  if ( this->IsEmpireGuardian1() == false && this->IsEmpireGuardian2() == false && this->IsEmpireGuardian3() == false &&
...
const wchar_t* CMapManager::GetMapName( int iMap )
{
  ...
  if ( iMap == WD_79UNITEDMARKETPLACE ) {
    return ( GlobalText[3'017] );
  }
  if ( iMap == WD_80KARUTAN1 || iMap == WD_81KARUTAN2 ) {
    return ( GlobalText[3'285] );
  }
