...
void SEASON3B::CNewUICatapultWindow::CCatapultGroupButton::Create( int iType, POINT ptWindow )
{
  ...
  if ( iType == CATAPULT_ATTACK ) {
    ...
    m_pButton[0].ChangeText( GlobalText[1'402] );
    ...
    m_pButton[1].ChangeText( GlobalText[1'403] );
    ...
    m_pButton[2].ChangeText( GlobalText[1'404] );
    ...
    m_pButton[3].ChangeText( GlobalText[1'405] );
    ...
    m_iBtnNum = 3;
    m_pButton = new CNewUIButton[m_iBtnNum];
    m_pButton[0].ChangeText( GlobalText[1'406] );
    m_pButton[0].ChangeTextBackColor( RGBA( 255, 255, 255, 0 ) );
    ...
    m_pButton[0].ChangeImgColor( BUTTON_STATE_UP, RGBA( 255, 255, 255, 255 ) );
    m_pButton[0].ChangeImgColor( BUTTON_STATE_DOWN, RGBA( 255, 255, 255, 255 ) );
    m_pButton[1].ChangeText( GlobalText[1'407] );
    m_pButton[1].ChangeTextBackColor( RGBA( 255, 255, 255, 0 ) );
    ...
    m_pButton[1].ChangeImgColor( BUTTON_STATE_UP, RGBA( 255, 255, 255, 255 ) );
    m_pButton[1].ChangeImgColor( BUTTON_STATE_DOWN, RGBA( 255, 255, 255, 255 ) );
    m_pButton[2].ChangeText( GlobalText[1'408] );
    m_pButton[2].ChangeTextBackColor( RGBA( 255, 255, 255, 0 ) );
...
void SEASON3B::CNewUICatapultWindow::SetButtonInfo()
{
  ...
  m_BtnFire.ChangeText( GlobalText[1'499] );
...
void SEASON3B::CNewUICatapultWindow::RenderTexts()
{
  ...
  if ( m_iType == CATAPULT_ATTACK ) {
    g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 13.f, GlobalText[1'400], 190, 0, RT3_SORT_CENTER );
  } else if ( m_iType == CATAPULT_DEFENSE ) {
    g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 13.f, GlobalText[1'401], 190, 0, RT3_SORT_CENTER );
  }

  float fLine = 50.f;
  g_pRenderText->RenderText( m_Pos.x, m_Pos.y + fLine, GlobalText[1'409], 190, 0, RT3_SORT_CENTER );
  fLine += 15.f;
  g_pRenderText->RenderText( m_Pos.x, m_Pos.y + fLine, GlobalText[1'410], 190, 0, RT3_SORT_CENTER );
  fLine += 15.f;
  g_pRenderText->RenderText( m_Pos.x, m_Pos.y + fLine, GlobalText[1'411], 190, 0, RT3_SORT_CENTER );
}
