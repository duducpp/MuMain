...
void SEASON3B::CNewUICommandWindow::InitButtons()
{
  ...
  m_BtnCommand[COMMAND_PURCHASE].ChangeText( GlobalText[1'124] );
  ...
  m_BtnCommand[COMMAND_GUILDUNION].ChangeText( GlobalText[1'352] );
  m_BtnCommand[COMMAND_RIVAL].ChangeText( GlobalText[1'321] );
  m_BtnCommand[COMMAND_RIVALOFF].ChangeText( GlobalText[1'322] );
...
bool SEASON3B::CNewUICommandWindow::CommandGuildUnion( CHARACTER* pSelectedCha )
{
  if ( Hero->GuildStatus != G_MASTER ) {
    g_pSystemLogBox->AddText( GlobalText[1'320], SEASON3B::TYPE_SYSTEM_MESSAGE );
    return false;
  }
  if ( pSelectedCha->GuildStatus == G_NONE ) {
    g_pSystemLogBox->AddText( GlobalText[1'385], SEASON3B::TYPE_SYSTEM_MESSAGE );
    return false;
  }
...
int SEASON3B::CNewUICommandWindow::CommandDual( CHARACTER* pSelectedCha )
{
  ...
  if ( iLevel < 30 ) {
    ...
    g_pSystemLogBox->AddText( GlobalText[2'866], SEASON3B::TYPE_ERROR_MESSAGE );
    return 3;
  } else if ( gMapManager.WorldActive == WD_79UNITEDMARKETPLACE ) {
    g_pSystemLogBox->AddText( GlobalText[3'063], SEASON3B::TYPE_ERROR_MESSAGE );
    return 3;
