...
#include "NewUI/GuildMakeWindow.h"
...
void SEASON3B::CNewUIMessageBoxButton::Render()
{
  ...
  RenderBitmap( m_dwTexType, m_x, m_y, m_width, m_height, ( 0.5f / (float)pImage->Width ),
                ( ( m_EventState * m_fButtonHeight + 0.5f ) / (float)pImage->Height ),
...
bool SEASON3B::CNewUI3DItemCommonMsgBox::Create( DWORD dwType, const type_string& strMsg, DWORD dwColor,
                                                 BYTE byFontType, float fPriority )
{
  int x, y, width, height;
...
bool SEASON3B::CMapEnterWerwolfMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'658], RGBA( 254, 176, 72, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[1'659], RGBA( 170, 218, 146, 255 ) );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[1'660] );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[1'676] );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[1'661] );
...
bool CMapEnterGateKeeperMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->SetPos( ( SCREEN_WIDTH / 2 ) - ( MSGBOX_WIDTH / 2 ), 50 );
  pMsgBox->AddMsg( GlobalText[1'662], 0xFF49B0FF, MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[1'663], 0xFF61F191 );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[1'664] );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[1'677] );
...
bool SEASON3B::CPersonalshopCreateMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'131] );
...
bool SEASON3B::CFenrirRepairMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'865], RGBA( 255, 255, 0, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CInfinityArrowCancelMsgBoxLayout::SetLayout()
{
  ...
  swprintf( strText, L"%ls%ls", SkillAttribute[AT_SKILL_INFINITY_ARROW].Name, GlobalText[2'046] );
...
bool SEASON3B::CBuffSwellOfMPCancelMsgBoxLayOut::SetLayout()
{
  ...
  wchar_t strText[MAX_GLOBAL_TEXT_STRING];
  swprintf( strText, L"%ls%ls", SkillAttribute[AT_SKILL_EXPANSION_OF_WIZARDRY].Name, GlobalText[2'046] );
...
bool SEASON3B::CGemIntegrationUnityResultMsgBoxLayout::SetLayout()
{
  ...
  swprintf( strText, L"%ls%ls %ls", GlobalText[1'801], GlobalText[1'816], GlobalText[858] );
...
bool SEASON3B::CGemIntegrationDisjointResultMsgBoxLayout::SetLayout()
{
  ...
  swprintf( strText, L"%ls%ls %ls", GlobalText[1'800], GlobalText[1'816], GlobalText[858] );
  pMsgBox->AddMsg( strText, RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CHarvestEventLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'020], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
...
bool SEASON3B::CUseReviveCharmMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'607] );
...
bool SEASON3B::CUsePortalCharmMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'609] );
...
bool SEASON3B::CDuelCreateErrorMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'692], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
  pMsgBox->AddMsg( GlobalText[2'693], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
...
bool SEASON3B::CDuelWatchErrorMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'706], RGBA( 255, 255, 128, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[2'707], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
...
bool SEASON3B::CSiegeLevelMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'429], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
  pMsgBox->AddMsg( GlobalText[1'430], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
...
bool SEASON3B::CSiegeGiveUpMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'498], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
...
bool SEASON3B::CGatemanMoneyMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'627], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
  pMsgBox->AddMsg( GlobalText[1'628], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_NORMAL );
...
bool SEASON3B::CQuestGiveUpMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'817] );
...
bool SEASON3B::CQuestCountLimitMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[3'279] );
  pMsgBox->AddMsg( GlobalText[3'280] );
  pMsgBox->AddMsg( GlobalText[3'281] );
  pMsgBox->AddMsg( GlobalText[3'282] );
  pMsgBox->AddMsg( GlobalText[3'283] );
...
bool SEASON3B::CUsePartChargeFruitMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( strName, RGBA( 255, 255, 0, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( GlobalText[2'524], RGBA( 255, 255, 0, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( GlobalText[2'525], RGBA( 255, 255, 0, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CPersonalShopItemBuyMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'100] );
...
bool SEASON3B::COsbourneMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'223], RGBA( 255, 0, 0, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( L" " );
  pMsgBox->AddMsg( GlobalText[2'224], RGBA( 223, 191, 103, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CGuildOutPerson::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'270], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CGuildBreakMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'363], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( GlobalText[1'364], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( GlobalText[1'365], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( GlobalText[1'366], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CGuildPerson_Get_Out::SetLayout()
{
  ...
  wchar_t Buff[300];
  swprintf( Buff, GlobalText[1'367], GuildList[DeleteIndex].Name );
  pMsgBox->AddMsg( Buff, RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
  pMsgBox->AddMsg( GlobalText[1'369], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CCry_Wolf_Result_Set_Temple::SetLayout()
{
  ...
  swprintf( Text, L"%ls    %ls    %ls    %ls", GlobalText[680], GlobalText[681], GlobalText[1'973], GlobalText[1'977] );
  ...
  for ( int i = 0; i < 5; i++ ) {
    ...
    swprintf( Text, L"%d      %ls      %ls      %d", i + 1, HeroName[i],
  ...
  if ( View_Suc_Or_Fail == 1 ) {
    swprintf( Text, GlobalText[2'000] );
    pMsgBox->AddMsg( Text, TextColor );
    swprintf( Text, GlobalText[2'001] );
    pMsgBox->AddMsg( Text, TextColor );
  } else {
    pMsgBox->AddMsg( GlobalText[2'009], TextColor );
  }
...
bool SEASON3B::CCry_Wolf_Ing_Set_Temple::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'002] );
...
bool SEASON3B::CCry_Wolf_Destroy_Set_Temple::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'003] );
...
bool SEASON3B::CCry_Wolf_Wat_Set_Temple1::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'008] );
...
bool SEASON3B::CCry_Wolf_Dont_Set_Temple1::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'004] );
  pMsgBox->AddMsg( GlobalText[2'005] );
...
bool SEASON3B::CCry_Wolf_Dont_Set_Temple::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'956] );
...
bool SEASON3B::CCry_Wolf_Set_Temple1::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'952] );
...
bool SEASON3B::CCry_Wolf_Set_Temple::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'953] );
  pMsgBox->AddMsg( GlobalText[1'954] );
...
bool SEASON3B::CMaster_Level_Interface::SetLayout()
{
  ...
  wchar_t szText[256];
  pMsgBox->AddMsg( GlobalText[1'771] );
  swprintf( szText, GlobalText[1'772], Need_Point );
...
bool SEASON3B::CCry_Wolf_Get_Temple::SetLayout()
{
  ...
  swprintf( szText, GlobalText[2'006], State );
  pMsgBox->AddMsg( szText );
  pMsgBox->AddMsg( GlobalText[2'007] );
  BackUp_Key = CharactersClient[TargetNpc].Key;
  pMsgBox->AddCallbackFunc( CCry_Wolf_Get_Temple::OkBtnDown, MSGBOX_EVENT_USER_COMMON_OK );
...
bool SEASON3B::CUnionGuild_Break_MsgBoxLayout::SetLayout()
{
  ...
  wchar_t szText[256];
  swprintf( szText, GlobalText[1'423], DeleteID );
  pMsgBox->AddMsg( szText );
  pMsgBox->AddMsg( GlobalText[1'369] );
...
bool SEASON3B::CUnionGuild_Out_MsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[1'271], RGBA( 255, 255, 255, 255 ), MSGBOX_FONT_BOLD );
...
bool SEASON3B::CUseSantaInvitationMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'590] );
...
bool CSantaTownLeaveMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'586] );
...
bool SEASON3B::CUseRegistLuckyCoinMsgBoxLayout::SetLayout()
{
  ...
  swprintf( szText, GlobalText[580], GlobalText[1'894] );
  pMsgBox->AddMsg( szText );
...
bool SEASON3B::CRegistOverLuckyCoinMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'859] );
...
bool SEASON3B::CExchangeLuckyCoinMsgBoxLayout::SetLayout()
{
  ...
  swprintf( szText, GlobalText[580], GlobalText[1'940] );
  pMsgBox->AddMsg( szText );
...
bool SEASON3B::CExchangeLuckyCoinInvenErrMsgBoxLayout::SetLayout()
{
  ...
  pMsgBox->AddMsg( GlobalText[2'306] );
