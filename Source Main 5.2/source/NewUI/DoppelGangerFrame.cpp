...
bool CNewUIDoppelGangerFrame::Render()
{
  ...
  swprintf( szText, GlobalText[2'772], m_iEnteredMonsters, m_iMaxMonsters );
  ...
  if ( m_bIceWalkerEnabled == TRUE ) {
    ...
    RenderImage( IMAGE_DOPPELGANGER_GUAGE_ICEWALKER, m_Pos.x + 59 - 6.5f + 167 * m_fIceWalkerPosition, m_Pos.y + 78 - 1,
                 13.0f, 7.0f );
  }
