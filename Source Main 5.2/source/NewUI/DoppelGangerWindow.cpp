...
bool CNewUIDoppelGangerWindow::Create( CNewUIManager* pNewUIMng, CNewUI3DRenderMng* pNewUI3DRenderMng, int x, int y )
{
  ...
  InitButton( &m_BtnEnter, m_Pos.x + INVENTORY_WIDTH / 2 - 27, m_Pos.y + 190, GlobalText[1'593] );
  InitButton( &m_BtnClose, m_Pos.x + INVENTORY_WIDTH / 2 - 27, m_Pos.y + 360, GlobalText[1'002] );
...
bool CNewUIDoppelGangerWindow::Render()
{
  ...
  CutStr( GlobalText[2'757], szTextOut[0], 140, 2, 300 );
  ...
  CutStr( GlobalText[2'758], szTextOut[0], 100, 2, 300 );
  ...
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 60, GlobalText[2'759], 190, 0, RT3_SORT_CENTER );

  g_pRenderText->SetFont( g_hFontBold );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 120, GlobalText[2'760], 190, 0, RT3_SORT_CENTER );
  ...
  g_pRenderText->SetFont( g_hFont );
  g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 210, GlobalText[2'761], 190, 0, RT3_SORT_CENTER );
  if ( m_iRemainTime == 0 ) {
    swprintf( szText, GlobalText[2'164] );
  } else {
    swprintf( szText, GlobalText[2'762], m_iRemainTime );
  }
...
void CNewUIDoppelGangerWindow::RenderFrame()
{
  ...
  swprintf( szText, L"%ls", GlobalText[2'756] );
