...
bool CNewUIDuelWatchMainFrameWindow::Create( CNewUIManager* pNewUIMng, CNewUI3DRenderMng* pNewUI3DRenderMng )
{
  ...
  m_BtnExit.ChangeToolTipText( GlobalText[2'702], true );
...
bool CNewUIDuelWatchMainFrameWindow::Render()
{
  ...
  if ( m_fPrevHPRate1 > fHPRate + fHPRatePerPixel ) {
    ...
    RenderImage( IMAGE_DUELWATCH_MAINFRAME_HP_GAUGE_FX, 60 + 236.f * ( 1.f - fHPRate ), 440, 236.f * fHPRate, 7.f,
                 235.f / 256.f * fHPRate, 0, -235.f / 256.f * fHPRate, 6.f / 8.f );
    RenderImage( IMAGE_DUELWATCH_MAINFRAME_HP_GAUGE, 60 + 236.f * ( 1.f - m_fPrevHPRate1 ), 440, 236.f * m_fPrevHPRate1,
                 7.f, 235.f / 256.f * m_fPrevHPRate1, 0, -235.f / 256.f * m_fPrevHPRate1, 6.f / 8.f );
  } else {
