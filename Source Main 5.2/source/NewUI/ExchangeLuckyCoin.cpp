...
void CNewUIExchangeLuckyCoin::RenderFrame()
{
  ...
  RenderImage( IMAGE_EXCHANGE_LUCKYCOIN_WINDOW_BOTTOM, m_Pos.x,
               m_Pos.y + float( EXCHANGE_LUCKYCOIN_WINDOW_HEIGHT ) - 45.f, float( EXCHANGE_LUCKYCOIN_WINDOW_WIDTH ),
               45.f );
}
...
void CNewUIExchangeLuckyCoin::RenderTexts()
{
  ...
  g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 25, GlobalText[1'892], 190, 0, RT3_SORT_CENTER );

  g_pRenderText->RenderText( m_TextPos.x, m_Pos.y + 200, GlobalText[1'940], EXCHANGE_LUCKYCOIN_WINDOW_WIDTH, 0,
                             RT3_SORT_CENTER );

  g_pRenderText->SetTextColor( 255, 255, 0, 255 );
  g_pRenderText->RenderText( m_TextPos.x, m_TextPos.y, GlobalText[1'895], EXCHANGE_LUCKYCOIN_WINDOW_WIDTH, 0,
                             RT3_SORT_CENTER );

  g_pRenderText->SetFont( g_hFont );
  g_pRenderText->SetTextColor( 255, 255, 255, 255 );
  int iTextPosy = m_TextPos.y + ( EXCHANGE_TEXT_VAL * 2 );
  g_pRenderText->RenderText( m_TextPos.x, iTextPosy, GlobalText[1'938], EXCHANGE_LUCKYCOIN_WINDOW_WIDTH, 0,
                             RT3_SORT_CENTER );
  iTextPosy += EXCHANGE_TEXT_VAL;
  g_pRenderText->RenderText( m_TextPos.x, iTextPosy, GlobalText[1'939], EXCHANGE_LUCKYCOIN_WINDOW_WIDTH, 0,
                             RT3_SORT_CENTER );
}
