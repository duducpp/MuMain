...
bool CNewUIGateSwitchWindow::Create( CNewUIManager* pNewUIMng, int x, int y )
{
  ...
  InitButton( &m_BtnOpen, m_Pos.x + 41, m_Pos.y + 320, GlobalText[1'479] );
...
bool CNewUIGateSwitchWindow::Render()
{
  ...
  g_pRenderText->RenderText( ptOrigin.x + 95, ptOrigin.y, GlobalText[1'476], 0, 0, RT3_WRITE_CENTER );
  ptOrigin.y += 17;
  g_pRenderText->RenderText( ptOrigin.x + 95, ptOrigin.y, GlobalText[1'477], 0, 0, RT3_WRITE_CENTER );
  ptOrigin.y += 17;

  g_pRenderText->SetBgColor( 160, 0, 0, 255 );
  g_pRenderText->RenderText( ptOrigin.x + 95, ptOrigin.y, GlobalText[1'478], 0, 0, RT3_WRITE_CENTER );
  ptOrigin.y += 17;
...
void CNewUIGateSwitchWindow::RenderFrame()
{
  ...
  swprintf( szText, L"%ls", GlobalText[1'475] );
