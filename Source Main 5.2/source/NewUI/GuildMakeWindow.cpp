...
bool CNewUIGuildMakeWindow::UpdateGMInfo()
{
  ...
  m_Button[GUILDMAKEBUTTON_INFO_MAKE].ChangeText( GlobalText[1'303] );
...
bool CNewUIGuildMakeWindow::UpdateGMMark()
{
  ...
  m_Button[GUILDMAKEBUTTON_MARK_LNEXT].ChangeText( GlobalText[1'306] );

  m_Button[GUILDMAKEBUTTON_MARK_RNEXT].SetPos( m_Pos.x + 110, m_Pos.y + 379 );
  m_Button[GUILDMAKEBUTTON_MARK_RNEXT].ChangeText( GlobalText[1'305] );
...
bool CNewUIGuildMakeWindow::UpdateGMResultInfo()
{
  ...
  m_Button[GUILDMAKEBUTTON_RESULTINFO_LNEXT].ChangeText( GlobalText[1'306] );

  m_Button[GUILDMAKEBUTTON_RESULTINFO_RNEXT].SetPos( m_Pos.x + 110, m_Pos.y + 379 );
  m_Button[GUILDMAKEBUTTON_RESULTINFO_RNEXT].ChangeText( GlobalText[1'305] );
