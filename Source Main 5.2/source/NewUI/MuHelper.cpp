...
void CNewUIMuHelper::InitButtons()
{
  ...
  ltext.push_back( GlobalText[3'500] );
  ltext.push_back( GlobalText[3'501] );
  ltext.push_back( GlobalText[3'590] );
  ...
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 191, 38, 24, 1, 0, 1, 1, GlobalText[3'502], L"",
                BUTTON_ID_SKILL2_CONFIG, 0 ); //-- skill 2
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 243, 38, 24, 1, 0, 1, 1, GlobalText[3'502], L"",
                BUTTON_ID_SKILL3_CONFIG, 0 ); //-- skill 3
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 84, 38, 24, 1, 0, 1, 1, GlobalText[3'502], L"",
                BUTTON_ID_POTION_CONFIG_ELF, 0 ); //-- Buff
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 79, 38, 24, 1, 0, 1, 1, GlobalText[3'502], L"",
                BUTTON_ID_POTION_CONFIG_SUMMY, 0 ); //-- potion
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 84, 38, 24, 1, 0, 1, 1, GlobalText[3'502], L"",
                BUTTON_ID_POTION_CONFIG, 0 ); //-- potion
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 17, m_Pos.y + 234, 38, 24, 1, 0, 1, 1, GlobalText[3'502], L"",
  ...
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 208, 38, 24, 1, 0, 1, 1, GlobalText[3'505], L"",
                BUTTON_ID_ADD_OTHER_ITEM, 1 ); //-- Buff
  InsertButton( IMAGE_CLEARNESS_BTN, m_Pos.x + 132, m_Pos.y + 309, 38, 24, 1, 0, 1, 1, GlobalText[3'506], L"",
                BUTTON_ID_DELETE_OTHER_ITEM, 1 ); //-- Buff
  //--
  InsertButton( IMAGE_IGS_BUTTON, m_Pos.x + 120, m_Pos.y + 388, 52, 26, 1, 0, 1, 1, GlobalText[3'503], L"",
                BUTTON_ID_SAVE_CONFIG, -1 );
  InsertButton( IMAGE_IGS_BUTTON, m_Pos.x + 65, m_Pos.y + 388, 52, 26, 1, 0, 1, 1, GlobalText[3'504], L"",
...
{
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 79, m_Pos.y + 80, 15, 15, 0, GlobalText[3'507], CHECKBOX_ID_POTION, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 122, 15, 15, 0, GlobalText[3'508],
                  CHECKBOX_ID_LONG_DISTANCE, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 137, 15, 15, 0, GlobalText[3'509],
                  CHECKBOX_ID_ORIG_POSITION, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 94, m_Pos.y + 174, 15, 15, 0, GlobalText[3'510],
                  CHECKBOX_ID_SKILL2_DELAY, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 94, m_Pos.y + 191, 15, 15, 0, GlobalText[3'511],
                  CHECKBOX_ID_SKILL2_CONDITION, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 94, m_Pos.y + 226, 15, 15, 0, GlobalText[3'510],
                  CHECKBOX_ID_SKILL3_DELAY, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 94, m_Pos.y + 243, 15, 15, 0, GlobalText[3'511],
                  CHECKBOX_ID_SKILL3_CONDITION, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 226, 15, 15, 0, GlobalText[3'512], CHECKBOX_ID_COMBO, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 276, 15, 15, 0, GlobalText[3'513],
                  CHECKBOX_ID_BUFF_DURATION, 0 );

  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 218, 15, 15, 0, GlobalText[3'514], CHECKBOX_ID_USE_PET,
                  0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 218, 15, 15, 0, GlobalText[3'515], CHECKBOX_ID_PARTY, 0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 79, m_Pos.y + 97, 15, 15, 0, GlobalText[3'516], CHECKBOX_ID_AUTO_HEAL,
                  0 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 79, m_Pos.y + 97, 15, 15, 0, GlobalText[3'517], CHECKBOX_ID_DRAIN_LIFE,
                  0 );

  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 79, m_Pos.y + 80, 15, 15, 0, GlobalText[3'518], CHECKBOX_ID_REPAIR_ITEM,
                  1 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 17, m_Pos.y + 125, 15, 15, 0, GlobalText[3'519], CHECKBOX_ID_PICK_ALL,
                  1 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 17, m_Pos.y + 152, 15, 15, 0, GlobalText[3'520],
                  CHECKBOX_ID_PICK_SELECTED, 1 );

  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 22, m_Pos.y + 170, 15, 15, 0, GlobalText[3'521], CHECKBOX_ID_PICK_JEWEL,
                  1 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 85, m_Pos.y + 170, 15, 15, 0, GlobalText[3'522],
                  CHECKBOX_ID_PICK_ANCIENT, 1 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 22, m_Pos.y + 185, 15, 15, 0, GlobalText[3'523], CHECKBOX_ID_PICK_ZEN,
                  1 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 85, m_Pos.y + 185, 15, 15, 0, GlobalText[3'524],
                  CHECKBOX_ID_PICK_EXCELLENT, 1 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 22, m_Pos.y + 200, 15, 15, 0, GlobalText[3'525],
                  CHECKBOX_ID_ADD_OTHER_ITEM, 1 );
  //--

  InsertCheckBox( IMAGE_MACROUI_HELPER_OPTIONBUTTON, m_Pos.x + 94, m_Pos.y + 235, 15, 15, 0, GlobalText[3'533],
                  CHECKBOX_ID_DR_ATTACK_CEASE, 0 );
  InsertCheckBox( IMAGE_MACROUI_HELPER_OPTIONBUTTON, m_Pos.x + 30, m_Pos.y + 235, 15, 15, 0, GlobalText[3'534],
                  CHECKBOX_ID_DR_ATTACK_AUTO, 0 );
  InsertCheckBox( IMAGE_MACROUI_HELPER_OPTIONBUTTON, m_Pos.x + 30, m_Pos.y + 250, 15, 15, 0, GlobalText[3'535],
                  CHECKBOX_ID_DR_ATTACK_TOGETHER, 0 );

  //--
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 80, 15, 15, 0, GlobalText[3'591],
                  CHECKBOX_ID_AUTO_ACCEPT_FRIEND, 2 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 125, 15, 15, 0, GlobalText[3'593],
                  CHECKBOX_ID_AUTO_DEFEND, 2 );
  InsertCheckBox( IMAGE_CHECKBOX_BTN, m_Pos.x + 18, m_Pos.y + 97, 15, 15, 0, GlobalText[3'592],
...
{
  InsertText( m_Pos.x + 18, m_Pos.y + 78, GlobalText[3'526], 1, 0 ); // Range
  InsertText( m_Pos.x + 18, m_Pos.y + 83, L"________", 2, 0 );
  InsertText( m_Pos.x + 110, m_Pos.y + 141, GlobalText[3'527], 3, 0 ); // Distance
  // InsertText(m_Pos.x + 162, m_Pos.y + 141, GlobalText[3528], 4, 0);
  InsertText( m_Pos.x + 162, m_Pos.y + 141, L"s", 4, 0 );

  InsertText( m_Pos.x + 18, m_Pos.y + 160, GlobalText[3'529], 5, 0 ); // Basic Skill
  InsertText( m_Pos.x + 59, m_Pos.y + 160, GlobalText[3'530], 7, 0 ); // Activation Skill 1
  // InsertText(m_Pos.x + 162, m_Pos.y + 178, GlobalText[3528], 8, 0);
  InsertText( m_Pos.x + 162, m_Pos.y + 178, L"s", 8, 0 );
  InsertText( m_Pos.x + 59, m_Pos.y + 212, GlobalText[3'531], 9, 0 ); // Activation Skill 2

  // InsertText(m_Pos.x + 162, m_Pos.y + 230, GlobalText[3528], 10, 0);
  InsertText( m_Pos.x + 162, m_Pos.y + 230, L"s", 10, 0 );
  InsertText( m_Pos.x + 18, m_Pos.y + 78, GlobalText[3'532], 11, 1 ); // Range
    ...
    case CHECKBOX_ID_COMBO: {
      ...
      if ( bState == true ) {
        if ( m_aiSelectedSkills[0] <= 0 || m_aiSelectedSkills[1] <= 0 || m_aiSelectedSkills[2] <= 0 ) {
          g_pSystemLogBox->AddText( GlobalText[3'565], SEASON3B::TYPE_ERROR_MESSAGE );
          cboxCombo.box->RegisterBoxState( false );
        }
      }
...
bool CNewUIMuHelper::Render()
{
  ...
  RenderImage( IMAGE_BASE_WINDOW_BOTTOM, m_Pos.x, m_Pos.y + float( WINDOW_HEIGHT ) - 45.f, float( WINDOW_WIDTH ),
               45.f );

  g_pRenderText->SetFont( g_hFontBold );

  g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 13, GlobalText[3'536], 190, 0, RT3_SORT_CENTER );

  RenderBack( m_Pos.x + 12, m_Pos.y + 340, 165, 46 );

  g_pRenderText->SetFont( g_hFont );
  g_pRenderText->RenderText( m_Pos.x + 20, m_Pos.y + 347, GlobalText[3'537], 0, 0, RT3_SORT_CENTER );

  g_pRenderText->SetTextColor( 0xFF00B4FF );
  g_pRenderText->RenderText( m_Pos.x + 20, m_Pos.y + 365, GlobalText[3'538], 0, 0, RT3_SORT_CENTER );
...
void CNewUIMuHelperExt::InitButtons()
{
  ...
  m_BtnPreConHuntRange.ChangeText( GlobalText[3'555] ); // "Monster Within Hunting range"
  ...
  m_BtnPreConAttacking.ChangeText( GlobalText[3'556] ); // "Monster Attacking Me"
  ...
  m_BtnSubConMoreThanTwo.ChangeText( GlobalText[3'557] ); // "More Than 2 Mobs"
  ...
  m_BtnSubConMoreThanThree.ChangeText( GlobalText[3'558] ); // "More Than 3 Mobs"
  ...
  m_BtnSubConMoreThanFour.ChangeText( GlobalText[3'559] ); // "More Than 4 Mobs"
  ...
  m_BtnReset.ChangeText( GlobalText[3'504] ); // "Initialization"
...
bool CNewUIMuHelperExt::Render()
{
  ...
  if ( m_iCurrentPage == SUB_PAGE_POTION_CONFIG_ELF ) {
    g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 13, GlobalText[3'553], 190, 0, RT3_SORT_CENTER ); // "Auto Recovery"
    RenderBackPane( m_Pos.x + 12, m_Pos.y + 55, 165, 45, GlobalText[3'545] );                       // "Auto Potion"
    RenderHpLevel( m_Pos.x + 32, m_Pos.y + 80, 124.f, 16.f, m_iCurrentPotionThreshold,
                   GlobalText[3'547] ); // "HP Status"

    RenderBackPane( m_Pos.x + 12, m_Pos.y + 120, 165, 45, GlobalText[3'546] ); // "Auto Heal"
    ...
    RenderBackPane( m_Pos.x + 12, m_Pos.y + 120, 165, 45, GlobalText[3'517] ); // "Drain Life"
    RenderHpLevel( m_Pos.x + 32, m_Pos.y + 145, 124.f, 16.f, m_iCurrentHealThreshold,
                   GlobalText[3'547] ); // "HP Status"
    ...
    RenderHpLevel( m_Pos.x + 32, m_Pos.y + 80, 124.f, 16.f, m_iCurrentPotionThreshold, GlobalText[3'547] );
  } else if ( m_iCurrentPage == SUB_PAGE_SKILL2_CONFIG || m_iCurrentPage == SUB_PAGE_SKILL3_CONFIG ) {
    g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 13, GlobalText[3'552], 190, 0,
                               RT3_SORT_CENTER );                             // "Activation Skill"
    RenderBackPane( m_Pos.x + 12, m_Pos.y + 55, 165, 45, GlobalText[3'543] ); // "Pre-con"
    m_BtnPreConHuntRange.Render();
    m_BtnPreConAttacking.Render();

    RenderBackPane( m_Pos.x + 12, m_Pos.y + 120, 165, 45, GlobalText[3'544] ); // "Sub-con"
    ...
    g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 13, GlobalText[3'554], 190, 0, RT3_SORT_CENTER ); // "Party"
    g_pRenderText->SetTextColor( TextColor );
    RenderBackPane( m_Pos.x + 12, m_Pos.y + 55, 165, 45, GlobalText[3'549] ); // Buff Support
    m_BtnPartyDuration.Render();
    g_pRenderText->RenderText( m_Pos.x + 40, m_Pos.y + 97, GlobalText[3'551], 124, 0,
    ...
    g_pRenderText->RenderText( m_Pos.x, m_Pos.y + 13, GlobalText[3'554], 190, 0, RT3_SORT_CENTER ); // "Party"
    g_pRenderText->SetTextColor( TextColor );
    RenderBackPane( m_Pos.x + 12, m_Pos.y + 55, 165, 70, GlobalText[3'548] ); // Heal Support
    m_BtnPartyHeal.Render();
    RenderHpLevel( m_Pos.x + 32, m_Pos.y + 100, 124.f, 16.f, m_iCurrentPartyHealThreshold,
                   GlobalText[3'550] ); // "HP Status of Party Members"

    RenderBackPane( m_Pos.x + 12, m_Pos.y + 145, 165, 45, GlobalText[3'549] ); // Buff Support
    m_BtnPartyDuration.Render();
    g_pRenderText->RenderText( m_Pos.x + 40, m_Pos.y + 187, GlobalText[3'551], 124, 0,
                               RT3_SORT_LEFT ); // "Time Space of Casting Buff"
...
void CNewUIMuHelperExt::RenderBackPane( int x, int y, int width, int height, const wchar_t* pszHeader )
{
  ...
  RenderImage( IMAGE_TABLE_RIGHT_PIXEL, ( x + width ) - 14.f, y + 24.f, 14.0,
               ( height - 14.f ) ); // Right edge of main box
