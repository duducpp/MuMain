...
bool SEASON3B::CNewUIMyShopInventory::Create( CNewUIManager* pNewUIMng, int x, int y )
{
  ...
  m_Button[MYSHOPINVENTORY_EXIT].ChangeToolTipText( GlobalText[1'002], true );
  ...
  m_Button[MYSHOPINVENTORY_OPEN].ChangeToolTipText( GlobalText[1'107], true );
  ...
  m_Button[MYSHOPINVENTORY_CLOSE].ChangeToolTipText( GlobalText[1'108], true );
...
void SEASON3B::CNewUIMyShopInventory::ChangePersonal( bool state )
{
  ...
  if ( m_EnablePersonalShop ) {
    ...
    m_Button[MYSHOPINVENTORY_OPEN].ChangeToolTipText( GlobalText[1'106], true );
  ...
  if ( m_pNewInventoryCtrl && pPickedItem && IsRelease( VK_LBUTTON ) ) {
    ...
    if ( pPickedItem->GetOwnerInventory() == g_pMyInventory->GetInventoryCtrl() ) {
      if ( IsPersonalShopBan( pItemObj ) == true ) {
        g_pSystemLogBox->AddText( GlobalText[2'226], SEASON3B::TYPE_ERROR_MESSAGE );
        return true;
      }
...
void SEASON3B::CNewUIMyShopInventory::RenderFrame()
{
  ...
  wchar_t Text[100] = {};
  swprintf( Text, GlobalText[1'102] );
...
void SEASON3B::CNewUIMyShopInventory::RenderTextInfo()
{
  ...
  if ( m_EnablePersonalShop ) {
    RenderText( GlobalText[1'103], m_Pos.x, m_Pos.y + 200, INVENTORY_WIDTH, 0, RGBA( 215, 138, 0, 255 ), 0x00000000,
                RT3_SORT_CENTER, g_hFontBold );
  }

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[370] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 230, 0, 0, RGBA( 255, 45, 47, 255 ), 0x00000000, RT3_SORT_LEFT,
              g_hFontBold );

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[1'109] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 250, 0, 0, RGBA( 247, 206, 77, 255 ), 0x00000000, RT3_SORT_LEFT );

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[1'111] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 262, 0, 0, RGBA( 247, 206, 77, 255 ), 0x00000000, RT3_SORT_LEFT );

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[1'112] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 274, 0, 0, RGBA( 247, 206, 77, 255 ), 0x00000000, RT3_SORT_LEFT );

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[1'113] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 286, 0, 0, RGBA( 247, 206, 77, 255 ), 0x00000000, RT3_SORT_LEFT );

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[1'115] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 298, 0, 0, RGBA( 247, 206, 77, 255 ), 0x00000000, RT3_SORT_LEFT );

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[1'134] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 320, 0, 0, RGBA( 255, 45, 47, 255 ), 0x00000000, RT3_SORT_LEFT,
              g_hFontBold );

  memset( &Text, 0, sizeof( wchar_t ) * 100 );
  swprintf( Text, GlobalText[1'135] );
  RenderText( Text, m_Pos.x + 30, m_Pos.y + 332, 0, 0, RGBA( 255, 45, 47, 255 ), 0x00000000, RT3_SORT_LEFT,
              g_hFontBold );
}
