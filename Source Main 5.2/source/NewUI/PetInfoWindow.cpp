...
void CNewUIPetInfoWindow::InitButtons()
{
  ...
  ltext.push_back( GlobalText[1'187] );
  ltext.push_back( GlobalText[1'214] );
  ...
  m_BtnExit.ChangeToolTipText( GlobalText[1'002], true ); // 1002 "�ݱ�"
}
...
bool CNewUIPetInfoWindow::Render()
{
  ...
  RenderImage( IMAGE_PETINFO_BOTTOM, m_Pos.x, m_Pos.y + float( PETINFOWINDOW_HEIGHT ) - 45.f,
               float( PETINFOWINDOW_WIDTH ), 45.f );

  g_pRenderText->SetFont( g_hFontBold );
  g_pRenderText->RenderText( m_Pos.x + 60, m_Pos.y + 13, GlobalText[1'217], 70, 0, RT3_SORT_CENTER );
  g_pRenderText->SetFont( g_hFont );
  m_BtnTab.Render();
  ...
  switch ( m_iNumCurOpenTab ) {
    case TAB_TYPE_DARKHORSE: {
      ...
      if ( pPetInfo->m_dwPetType == PET_TYPE_NONE ) {
        ...
        swprintf( szText, GlobalText[1'233], GlobalText[1'187] );
    ...
    case TAB_TYPE_DARKSPIRIT: {
      ...
      if ( pPetInfo->m_dwPetType == PET_TYPE_NONE ) {
        g_pRenderText->SetTextColor( 0xFF0000FF );
        g_pRenderText->SetFont( g_hFontBold );
        g_pRenderText->RenderText( m_Pos.x + 15, m_Pos.y + 100, GlobalText[1'169], 160, 30, RT3_SORT_CENTER );
      } else {
...
bool CNewUIPetInfoWindow::RenderDarkHorseInfo( PET_INFO* pPetInfo )
{
  ...
  g_pRenderText->RenderText( m_Pos.x + 60, m_Pos.y + 25, GlobalText[1'187], 70, 0, RT3_SORT_CENTER );
...
bool CNewUIPetInfoWindow::RenderDarkSpiritInfo( PET_INFO* pPetInfo )
{
  ...
  g_pRenderText->SetFont( g_hFont );
  g_pRenderText->SetTextColor( 255, 255, 255, 255 );
  g_pRenderText->RenderText( m_Pos.x + 60, m_Pos.y + 25, GlobalText[1'214], 70, 0, RT3_SORT_CENTER );
  ...
  g_pRenderText->RenderText( iGBox2PosX + 2, iGBox2PosY + 8, GlobalText[1'218], 70 - 14, 0, RT3_SORT_CENTER );
  ...
  g_pRenderText->RenderText( iGBox2PosX + 52, iGBox2PosY + 45, GlobalText[1'219], 0, 0, RT3_SORT_CENTER );
  g_pRenderText->RenderText( iGBox2PosX + 52, iGBox2PosY + 85, GlobalText[1'220], 0, 0, RT3_SORT_CENTER );
  g_pRenderText->RenderText( iGBox2PosX + 52, iGBox2PosY + 125, GlobalText[1'221], 0, 0, RT3_SORT_CENTER );
  g_pRenderText->RenderText( iGBox2PosX + 52, iGBox2PosY + 165, GlobalText[1'222], 0, 0, RT3_SORT_CENTER );
  return true;
}
