...
void CNewUIRegistrationLuckyCoin::SetBtnInfo()
{
  ...
  m_RegistButton.ChangeText( GlobalText[1'894] );
  ...
  m_CloseButton.ChangeText( GlobalText[1'002] );
}
