...
bool CNewUIUnitedMarketPlaceWindow::Create( CNewUIManager* pNewUIMng, CNewUI3DRenderMng* pNewUI3DRenderMng, int x,
                                            int y )
{
  ...
  InitButton( &m_BtnEnter, m_Pos.x + INVENTORY_WIDTH / 2 - 27, m_Pos.y + 230, GlobalText[3'016] );

  m_BtnClose.ChangeButtonImgState( true, IMAGE_UNITEDMARKETPLACEWINDOW_BTN_CLOSE );
  m_BtnClose.ChangeButtonInfo( x + 13, y + 392, 36, 29 );
  m_BtnClose.ChangeToolTipText( GlobalText[1'002], true );
...
bool CNewUIUnitedMarketPlaceWindow::Render()
{
  ...
  if ( gMapManager.WorldActive == WD_79UNITEDMARKETPLACE ) {
    ...
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 10, GlobalText[3'010], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 30, GlobalText[3'011], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 50, GlobalText[3'012], 190, 0, RT3_SORT_CENTER );

    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 130, GlobalText[3'013], 190, 0, RT3_SORT_CENTER );
  } else {
    g_pRenderText->SetFont( g_hFont );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 10, GlobalText[3'003], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 30, GlobalText[3'004], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 50, GlobalText[3'005], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 70, GlobalText[3'006], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 90, GlobalText[3'007], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 110, GlobalText[3'008], 190, 0, RT3_SORT_CENTER );
    g_pRenderText->RenderText( ptOrigin.x, ptOrigin.y + 130, GlobalText[3'009], 190, 0, RT3_SORT_CENTER );
  }
...
void CNewUIUnitedMarketPlaceWindow::RenderFrame()
{
  ...
  swprintf( szText, L"%ls", GlobalText[3'000] );
