...
#define SLIDE_TEXT_LENGTH 1'024
...
public:
  ...
  BOOL AddSlideText( const wchar_t* pszNewText,
...
public:
  ...
  virtual void SetNumRenderLine( int nLine );
  IGS_BuyList* GetSelectedText() { return ( SLGetSelectLine() == m_TextList.end() ? NULL : &( *SLGetSelectLine() ) ); }
