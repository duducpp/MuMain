...
const DWORD g_cdwLetterCost = 1'000;
...
public:
  ...
  void  AddWindow( DWORD dwUIID, const wchar_t* pszTitle ) { m_ChatRoomListWnd.AddWindow( dwUIID, pszTitle ); }
  void  RemoveWindow( DWORD dwUIID ) { m_ChatRoomListWnd.RemoveWindow( dwUIID ); }
  DWORD GetCurrentSelectedWindow() { return m_ChatRoomListWnd.GetCurrentSelectedWindow(); }
  void  ResetWindow() { m_ChatRoomListWnd.Reset(); }

  void             RefreshLetterList() { m_LetterBoxWnd.RefreshLetterList(); }
  LETTERLIST_TEXT* GetCurrentSelectedLetter() { return m_LetterBoxWnd.GetCurrentSelectedLetter(); }
  void             PrevNextCursorMove( int iMove ) { m_LetterBoxWnd.PrevNextCursorMove( iMove ); }
...
{
public:
  CUIQuestionWindow( int iDialogType = 0 )
      : m_dwReturnWindowUIID( 0 )
