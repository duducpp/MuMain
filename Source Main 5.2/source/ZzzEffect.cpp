    ...
    if ( !o->Live ) {
      ...
      switch ( Type ) {
          ...
          switch ( o->SubType ) {
            ...
            case 3:
              Vector( o->Position[0], o->Position[1],
                      RequestTerrainHeight( o->Position[0], o->Position[1] ) - (float)o->PKKey - 80, o->StartPosition );
        ...
        case MODEL_STREAMOFICEBREATH: {
          ...
          const float RANDNUM               = ( (float)( ( rand() % 2'000 ) - 1'000 ) * 0.001f );
...

          {
            ...
            case 1: {
              ...
              for ( int i = 0; i < 9; i++ ) {
                Vector( o->Position[0] + ( rand() % 200 - 100 ), o->Position[1] + ( rand() % 200 - 100 ),
                        o->Position[2] + ( rand() % 200 - 100 ), vPos );
                CreateEffect( MODEL_DOOR_CRUSH_EFFECT_PIECE11 + ( i % 3 ), vPos, o->Angle, o->Light, 0, o->Owner, 0,
                              0 );
              }
            } break;
          }
        ...
        case MODEL_STATUE_CRUSH_EFFECT: {
          for ( int i = 0; i < 6; i++ ) {
            CreateEffect( MODEL_STATUE_CRUSH_EFFECT_PIECE01 + ( i % 3 ), o->Position, o->Angle, o->Light, 0, o->Owner,
                          0, 0 );
          }
        } break;
            ...
            switch ( o->Type ) {
              ...
              case MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_: {
                if ( o->SubType == 1 ) // 일반공격 Animation
                {
                  ...
                  vec3_t v3PosProcess01, v3PosProcessFinal, v3AngleOffset, v3Dir, v3DirPower, v3DirModify, v3DirModifyR;
        ...
        case MODEL_EMPIREGUARDIAN_BLOW_OF_DESTRUCTION: {
          if ( o->SubType == 0 ) {
            ...
            CreateEffect( MODEL_EMPIREGUARDIAN_BLOW_OF_DESTRUCTION, o->StartPosition, o->Angle, o->Light, 1, o->Owner,
                          -1, 0, 0, 0, o->Scale );
          } else if ( o->SubType == 1 ) {
            o->LifeTime = 40;
            Vector( 1.2f, 1.2f, 1.2f, o->Light );
...
void MoveEffect( OBJECT* o, int iIndex )
{
  ...
  switch ( o->Type ) {
    ...
    case MODEL_SHIELD_CRASH: {
      ...
      if ( (int)o->LifeTime == 23 ) {
        if ( o->SubType == 1 ) {
          ...
          CreateEffectFpsChecked( BITMAP_SHOCK_WAVE, o->Owner->Position, o->Owner->Angle, nLight, 9, o->Owner, -1, 0, 0,
                                  0 );
        } else if ( o->SubType == 2 ) {
          vec3_t vShockColor = { 0.8f, 0.3f, 0.3f };
          CreateEffectFpsChecked( BITMAP_SHOCK_WAVE, o->Owner->Position, o->Owner->Angle, vShockColor, 9, o->Owner, -1,
                                  0, 0, 0 );
        } else {
    ...
    case MODEL_GHOST: {
      ...
      o->Angle[2] += ( sinf( (int)WorldTime % 10'000 * 0.0001f ) * o->Gravity ) * FPS_ANIMATION_FACTOR;
      o->Angle[0] += ( sinf( (int)WorldTime % 10'000 * 0.0001f ) * o->Distance / 3.0f ) * FPS_ANIMATION_FACTOR;
    ...
    case 9:
      ...
      if ( o->Position[2] < 350.f && o->PKKey == 0 ) {
        ...
        AddWaterWave( PositionX, PositionY, 2, -1'000 );
      }
      break;
    ...
    case MODEL_SUMMONER_EQUIP_HEAD_SAHAMUTT:
      if ( o->SubType == 0 ) {
        ...
        if ( rand_fps_check( 2 ) ) {
          ...
          CreateEffectFpsChecked( BITMAP_FIRE_CURSEDLICH, pObject->Position, pObject->Angle, pObject->Light, 0, pObject,
                                  -1, rand() % iNumBones );
        }
      }
      break;
        ...
        case 4:
          if ( o->Owner == NULL || o->Owner->Live == false || o->Alpha <= 0.0f ) {
            ...
            if ( !pModel->Bones[11].Dummy ) {
              ...
              pModel->Animation( BoneTransform, Owner->AnimationFrame, Owner->PriorAnimationFrame, Owner->PriorAction,
                                 Owner->Angle, Owner->HeadAngle, false, false );
      ...
      switch ( o->SubType ) {
        ...
        case 2: {
          ...
          if ( o->SubType == 0 ) {
            ...
            CreateJointFpsChecked( BITMAP_JOINT_THUNDER, vPos, pTargetObj->Position, vAngle, 0, pTargetObj, 50.f, -1, 0,
                                   0, -1, vLight );
            CreateJointFpsChecked( BITMAP_JOINT_THUNDER, vPos, pTargetObj->Position, vAngle, 0, pTargetObj, 10.f, -1, 0,
                                   0, -1, vLight );
            ...
            CreateJointFpsChecked( BITMAP_JOINT_THUNDER, vPos, pTargetObj->Position, pTargetObj->Angle, 0, pTargetObj,
                                   50.f, -1, 0, 0, -1, vLight );
            CreateJointFpsChecked( BITMAP_JOINT_THUNDER, vPos, pTargetObj->Position, pTargetObj->Angle, 0, pTargetObj,
                                   10.f, -1, 0, 0, -1, vLight );
          }
    ...
    case MODEL_ALICE_DRAIN_LIFE: {
      ...
      if ( o->LifeTime <= 70 && o->LifeTime >= 66 ) {
        ...
        for ( int i = 0; i < iCnt2; i++ ) {
          ...
          CreateJointFpsChecked( BITMAP_DRAIN_LIFE_GHOST, vSourcePos, vTargetPos, o->Angle, 0, pSourceObj, 40.f, 0, 0,
                                 0, -1, vLight );
        }
      }
      ...
      if ( (int)o->LifeTime == 64 ) {
        ...
        for ( int i = 0; i < iNumBones; i++ ) {
          ...
          if ( rand_fps_check( 2 ) ) {
            ...
            CreateJointFpsChecked( BITMAP_JOINT_ENERGY, vTargetPos, vSourcePos, pTargetObj->Angle, 45, pSourceObj,
                                   10.0f, -1, 0, 0, -1, vLight );
          }
        }
      }
    } break;
    ...
    case MODEL_BALGAS_SKILL:
      ...
      Vector( Luminosity * 0.3f, Luminosity * 0.6f, Luminosity, Light );
      {
        ...
        b->PlayAnimation( &o->AnimationFrame, &o->PriorAnimationFrame, &o->PriorAction, o->Velocity * 2.0f, o->Position,
                          o->Angle );
        AddTerrainLight( o->Position[0], o->Position[1], Light, 3, PrimaryTerrainLight );
      }
      break;
    ...
    case MODEL_STORM3: {
      ...
      for ( int i = 0; i < 5; i++ ) {
        if ( rand_fps_check( 2 ) ) {
          ...
          Pos1[0] = o->StartPosition[0] + rand() % 2'000 - 1000.0f;
          Pos1[1] = o->StartPosition[1] + rand() % 2'000 - 1000.0f;
    ...
    case MODEL_STONE2:
      if ( o->SubType == 5 ) {
        ...
        // 			if (rand_fps_check(3))
        // 			{
        // 				CreateParticle(BITMAP_FIRE_CURSEDLICH, o->Position, o->Angle, o->Light, 0, 1,
        // o);
        // 			}
        break;
      }
    ...
    case MODEL_FIRE:
      ...
      if ( o->SubType == 5 ) {
        ...
        if ( o->SubType == 6 || o->SubType == 7 ) {
          ...
          vec3_t Pos;
          vec3_t vRot;
          GetMagicScrew( iIndex * 5'371, vRot );
    ...
    case BITMAP_SWORD_FORCE:
      if ( o->LifeTime == 30.f ) // at the first frame of the effect
      {
        ...
        if ( o->SubType == 1 ) {
          vec3_t Light;
          Vector( 1.f, 1.f, 1.f, Light );
          CreateJointFpsChecked( BITMAP_JOINT_FORCE, Position, Position, o->HeadAngle, 10, o->Owner, 150.f, o->PKKey,
                                 o->Skill, 0, -1, Light );
        } else if ( o->SubType == 0 ) {
          CreateJointFpsChecked( BITMAP_JOINT_FORCE, Position, Position, o->HeadAngle, 0, o->Owner, 150.f, o->PKKey,
                                 o->Skill );
        } else {
          CreateJointFpsChecked( BITMAP_JOINT_FORCE, Position, Position, o->HeadAngle, 8, o->Owner, 150.f, o->PKKey,
                                 o->Skill );
        }
      }
      break;
    ...
    case BITMAP_BLIZZARD:
      if ( o->LifeTime <= 15 ) {
        if ( o->SubType == 0 ) {
          o->Position[0] = o->StartPosition[0] + sinf( ( rand() % 1'000 ) * 0.01f ) * 10.f;
          o->Position[1] = o->StartPosition[1] + sinf( ( rand() % 1'000 ) * 0.01f ) * 10.f;
          o->Position[2] += ( o->Gravity ) * FPS_ANIMATION_FACTOR;
          o->Gravity -= ( 2.f ) * FPS_ANIMATION_FACTOR;
    ...
    case MODEL_BLIZZARD:
      if ( o->SubType == 0 ) {
        ...
        o->Position[0] = o->StartPosition[0] + sinf( ( rand() % 1'000 ) * 0.01f ) * 50.f;
        o->Position[1] = o->StartPosition[1] + sinf( ( rand() % 1'000 ) * 0.01f ) * 50.f;
        o->Position[2] += ( o->Gravity ) * FPS_ANIMATION_FACTOR;
        o->Gravity -= ( rand() % 5 ) * FPS_ANIMATION_FACTOR;
          ...
          if ( fPreRate < fCurrentRate ) {
            for ( int Loop_bk = 0; Loop_bk < 2; Loop_bk++ ) {
              ...
              for ( int i = 0; i < iAccess; i++ ) {
                ...
                CreateObjectBlur( o, arrEachBonePos[iBone01], arrEachBonePos[iBone02], vLightBlur, iTypeBlur, false,
                                  iBlurIdentity, 20 );
    ...
    case MODEL_CUNDUN_GHOST:
      if ( o->Owner != NULL ) {
        ...
        Vector( 1, 1, 1, Light );
        VectorCopy( o->Position, Position );
        Position[0] += rand() % 1'200 - 600;
        Position[1] += rand() % 1'200 - 600;
        vec3_t Angle;
      ...
      if ( o->SubType == 0 || o->SubType == 1 ) {
        ...
        if ( o->Position[2] < fHeight ) {
          ...
          for ( int i = 0; i < iRand; ++i ) {
            ...
            CreateEffectFpsChecked( MODEL_FALL_STONE_EFFECT, o->Position, o->Angle, o->Light, 3, NULL, -1, 0, 0, 0,
                                    fScale );
          }
    ...
    case MODEL_TWINTAIL_EFFECT: {
      if ( o->SubType == 0 ) {
        ...
        if ( timeGetTime() - o->m_dwTime > 1'000 ) {
          if ( o->m_iAnimation == 0 ) {
            o->m_iAnimation = 1;
          } else {
            o->m_iAnimation = 0;
      ...
      if ( ( o->SubType == 0 ) || ( o->SubType == 1 ) ) {
        if ( o->Owner->Live && o->Live ) {
          ...
          if ( (int)o->LifeTime == 30 || (int)o->LifeTime == 15 || (int)o->LifeTime == 4 ) {
            ...
            characterBMD->Animation( o->Owner->BoneTransform, o->Owner->AnimationFrame, o->Owner->PriorAnimationFrame,
                                     o->Owner->PriorAction, o->Owner->Angle, o->Owner->HeadAngle );
      ...
      if ( o->SubType == 0 ) {
        ...
        if ( o->LifeTime <= 24 ) {
          ...
          if ( (int)o->LifeTime == 23 ) {
            ...
            CreateEffectFpsChecked( MODEL_RAKLION_BOSS_CRACKEFFECT, o->Position, o->Angle, vLight, 0, o, -1, 0, 0, 0,
                                    0.2f );
    ...
    case MODEL_SWELL_OF_MAGICPOWER: {
      if ( o->SubType == 0 ) {
        ...
        if ( o->LifeTime >= 30 ) {
          ...
          for ( int i = 0; i < 2; i++ ) {
            CreateJointFpsChecked( BITMAP_2LINE_GHOST, o->Position, o->Position, o->Angle, 1, o, 20.0f + rand() % 10,
                                   -1, 0, 0, -1, vLight );
          }
        }
      }
              ...
              switch ( o->Type ) {
                ...
                case MODEL_SWORDLEFT01_EMPIREGUARDIAN_BOSS_GAION_: {
                  for ( int i = 0; i < iAccess; i++ ) {
                    ...
                    if ( rand_fps_check( 2 ) ) {
                      ...
                      VectorRotate( vRandomDir, matRandomRotation, vRandomDirPosition );
                      VectorAdd( vPosition, vRandomDirPosition, vResultRandomPosition );
                      CreateJointFpsChecked( BITMAP_JOINT_THUNDER, vResultRandomPosition, vPosition, vAngle, 3, NULL,
                                             10.f, 10, 10 );
                    }
                  }
                } break;
                ...
                case MODEL_EMPIREGUARDIANBOSS_FRAMESTRIKE: {
                  ...
                  for ( int i = 0; i < iAccess; i++ ) {
                    ...
                    CreateObjectBlur( o, arrEachBonePos[iBone01], arrEachBonePos[iBone02], vLightBlur, 13, false,
                                      iBlurIdentity + 2, 11 );
                  }
                } break;
              } // Switch(o->Type)
...

              {
                ...
                for ( int j = 0; j < 11; ++j ) {
                  if ( rand_fps_check( 20 ) ) {
                    CreateEffectFpsChecked( BITMAP_FIRE_CURSEDLICH, arrEachBonePos[j], vAngle, v3LightModify, 12, o, -1,
                                            0, 0, 0, o->Scale );
                  }
                }
              }
          ...
          case MODEL_EMPIREGUARDIANBOSS_FRAMESTRIKE: {
            if ( fCurrentRate >= 0.0f && fCurrentRate <= 0.5f ) {
              ...
              for ( int i = 0; i < b->NumBones; i++ ) {
                ...
                if ( rand_fps_check( 10 ) ) {
                  CreateEffectFpsChecked( BITMAP_FIRE_CURSEDLICH, v3PosModify, vAngle, v3LightModify, 12, o, -1, 0, 0,
                                          0, o->Scale * 1.5f );
                }
              }
        ...
        switch ( o->Type ) {
          ...
          case MODEL_EMPIREGUARDIANBOSS_FRAMESTRIKE: {
            if ( (int)o->LifeTime == 10 ) {
              CreateEffectFpsChecked( MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_, o->Position, o->Angle, o->Light, 11,
        ...
        switch ( o->Type ) {
          ...
          case MODEL_SWORDLEFT02_EMPIREGUARDIAN_BOSS_GAION_: {
            ...
            if ( (int)o->LifeTime == 0 ) {
              ...
              CreateEffectFpsChecked( o->Type, oHighHier->Position, oHighHier->Angle, oHighHier->Light, 11, o->Owner,
                                      -1, 0, 0, 0, o->Scale );
            }
          ...
          case MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_: {
            if ( (int)o->LifeTime == 40 ) {
              ...
              CreateEffectFpsChecked( MODEL_EFFECT_THUNDER_NAPIN_ATTACK_1, vPosition, o->Angle, vLight, 1, NULL, -1, 0,
                                      0, 0, 1.0f );
            }
          } break;
        }
        ...
        if ( fCurrentRate >= 0.0f && fCurrentRate <= 0.5f ) {
          ...
          switch ( o->Type ) {
            ...
            case MODEL_SWORDRIGHT02_EMPIREGUARDIAN_BOSS_GAION_: {
              ...
              for ( int j = 0; j < 11; ++j ) {
                if ( rand_fps_check( 2 ) ) {
                  CreateParticleFpsChecked( BITMAP_FIRE_HIK1_MONO, arrEachBonePos[j], o->Angle, v3LightModify, 10,
                                            o->Scale );
                }
              }
            } break;
        ...
        if ( o->LifeTime <= 24 ) {
          ...
          if ( (int)o->LifeTime == 23 ) {
            ...
            for ( int i = 0; i < iNum; ++i ) {
              ...
              CreateEffectFpsChecked( MODEL_KNIGHT_PLANCRACK_B, vPos, vAngle, vLight, 0, o, 0, 0, 0, 0, o->Scale );
            }
          }
    ...
    case MODEL_EFFECT_UMBRELLA_DIE: {
      if ( o->SubType == 0 ) {
        if ( (int)o->LifeTime == 28 || (int)o->LifeTime == 18 || (int)o->LifeTime == 8 ) {
          ...
          CreateEffectFpsChecked( BITMAP_RING_OF_GRADATION, o->Owner->Position, o->Angle, vLight, 0, o->Owner, 0, 0, 0,
                                  0, 1.2f );
        }
      }
    } break;
    ...
    case MODEL_DOWN_ATTACK_DUMMY_R: {
      if ( o->Owner->Live ) {
        ...
        if ( o->AnimationFrame >= 6.0f || !o->Owner->Live ) {
          o->Live = false;
          CreateEffectFpsChecked( MODEL_DOWN_ATTACK_DUMMY_L, o->Owner->Position, o->Owner->Angle, o->Owner->Light, 0,
                                  o->Owner );
        }
        ...
        if ( g_isCharacterBuff( o->Owner, eBuff_Def_up_Ourforces ) ) {
          if ( rand() % 70 == 7 ) {
            if ( !SearchEffect( MODEL_WINDFOCE_MIRROR, o->Owner ) ) {
              ...
              CreateEffectFpsChecked( MODEL_WINDFOCE_MIRROR, o->Owner->Position, o->Angle, vLight, 0, o->Owner, -1, 0,
                                      0, 0, 1.0f );
            }
          }
        }
        ...
        if ( o->Owner->AnimationFrame > 5 ) {
          for ( int j = 0; j < 2; ++j ) {
            ...
            for ( int i = 0; i < 4; ++i ) {
              ...
              if ( i % 2 ) {
                Vector( vPos[0] + rand() % 40 + 20.0f, vPos[1] + rand() % 30 + 10.0f, vPos[2] + rand() % 30 + 25.0f,
                        vPos );
              } else {
                Vector( vPos[0] - rand() % 20 - 10.0f, vPos[1] + rand() % 30 - 10.0f, vPos[2] + rand() % 30 + 30.0f,
                        vPos );
              }
            }
          }
  ...
  if ( o->Type == MODEL_SKILL_WHEEL1 || o->Type == MODEL_SKILL_WHEEL2 || o->Type == MODEL_SKILL_FURY_STRIKE ||
    ...
    if ( o->Type >= MODEL_BIRD01 && o->Type < MODEL_SKILL_END ) {
      BMD* b           = &Models[o->Type];
      b->CurrentAction = o->CurrentAction;
      if ( o->CurrentAction != 255 && b->PlayAnimation( &o->AnimationFrame, &o->PriorAnimationFrame, &o->PriorAction,
                                                        o->Velocity, o->Position, o->Angle ) == false ) {
...
void RenderFuryStrike( OBJECT* o )
{
  if ( o->LifeTime > 10.f && o->Kind == 0 ) {
    ...
    b->Animation( BoneTransform, o->AnimationFrame, o->PriorAnimationFrame, o->PriorAction, Angle, o->HeadAngle, false,
                  false );
    RenderPartObject( o, Type, NULL, Light, Alpha, o->Owner->WeaponLevel, 0, 0, true, true, true );
      ...
      if ( o->Visible ) {
        ...
        switch ( o->Type ) {
          ...
          case MODEL_TWINTAIL_EFFECT: {
            if ( o->SubType == 0 ) {
              EnableAlphaBlend();
              RenderTerrainAlphaBitmap( BITMAP_SPARK + 1, o->Position[0], o->Position[1], o->Scale, o->Scale, o->Light,
                                        0.f, o->Alpha );
              DisableAlphaBlend();
            } else if ( o->SubType == 1 || o->SubType == 2 ) {
              EnableAlphaBlend();
              RenderTerrainAlphaBitmap( BITMAP_CLOUD, o->Position[0], o->Position[1], o->Scale, o->Scale, o->Light,
                                        o->Angle[0], o->Alpha );
              DisableAlphaBlend();
            }
          } break;
          ...
          case MODEL_SWORDMAIN01_EMPIREGUARDIAN_BOSS_GAION_: {
            ...
            if ( true == o->ChromeEnable ) {
              ...
              pBMDSwordModel->AnimationTransformWithAttachHighModel_usingGlobalTM(
                  o->Owner, pOwnerModel, iBoneIdx, v3CurrentHighHierarchyNodePos, arrEachBoneTranslations, true );
            } else {
              ...
              pBMDSwordModel->Animation( BoneTransform, o->AnimationFrame, o->PriorAnimationFrame, o->PriorAction,
            ...
            Vector( 1.0f, 1.0f, 1.0f, pBMDSwordModel->BodyLight );
            pBMDSwordModel->RenderMesh( 1, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                                        o->BlendMeshTexCoordU, o->BlendMeshTexCoordV );

            Vector( 0.2f, 0.2f, 1.0f, pBMDSwordModel->BodyLight );
            o->Alpha = 1.0f;
            pBMDSwordModel->RenderMesh( 2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                                        o->BlendMeshTexCoordU, o->BlendMeshTexCoordV );
            o->Alpha = 1.0f;

            if ( o->SubType != 20 ) {
              vec3_t vRelative, vLight;
              vec3_t vPos_SwordEffectRed01, vPos_SwordEffectRed02, vPos_SwordEffectEdge01, vPos_SwordEffectEdge02,
                  vPos_SwordEffectEdge03, vPos_SwordEffectEdge04, vPos_SwordEffectEdge05, vPos_SwordEffectEdge06,
                  vPos_SwordEffectEdge07, vPos_SwordEffectEdge08, vPos_SwordEffectEdge09;
              float fLumi1, fLumi2;
          ...
          case BITMAP_EVENT_CLOUD: {
            EnableAlphaBlend();
            RenderTerrainAlphaBitmap( BITMAP_EVENT_CLOUD, o->Position[0], o->Position[1], o->Scale, o->Scale, o->Light,
                                      o->Angle[0], o->Alpha );
            DisableAlphaBlend();
          } break;
          case MODEL_SHOCKWAVE02: {
          ...
          case BITMAP_LIGHT_RED: {
            ...
            if ( o->SubType == 0 ) {
              EnableAlphaBlend();
              RenderTerrainAlphaBitmap( BITMAP_LIGHT_RED, o->Owner->Position[0], o->Owner->Position[1], fScale, fScale,
              ...
              EnableAlphaBlend();
              RenderTerrainAlphaBitmap( BITMAP_LIGHT_RED, o->Position[0], o->Position[1], fScale, fScale, vLight,
                                        o->Angle[0], o->Alpha );
              RenderTerrainAlphaBitmap( BITMAP_LIGHT_RED, o->Position[0], o->Position[1], fScale, fScale, vLight,
                                        o->Angle[0], o->Alpha );
              DisableAlphaBlend();
    ...
    if ( o->Live ) {
      if ( o->Visible ) {
        ...
        switch ( o->Type ) {
          case BITMAP_MAGIC:
            if ( o->SubType == 1 ) {
              RenderTerrainAlphaBitmap( BITMAP_MAGIC, o->Position[0], o->Position[1], o->Scale, o->Scale, o->Light,
                                        -o->Angle[2] );
              ...
              RenderTerrainAlphaBitmap( o->Type, o->Position[0], o->Position[1], o->Scale, o->Scale, o->Light,
                                        -o->Angle[2] );
              RenderTerrainAlphaBitmap( o->Type, o->Position[0], o->Position[1], o->Scale * 0.8f, o->Scale * 0.8f,
                                        o->Light, -o->Angle[2] );
              RenderTerrainAlphaBitmap( o->Type, o->Position[0], o->Position[1], o->Scale * 1.2f, o->Scale * 1.2f,
                                        o->Light, -o->Angle[2] );
            } else if ( o->SubType == 9 ) {
              vec3_t vLight;
              Vector( o->Light[0] * o->Alpha, o->Light[1] * o->Alpha, o->Light[2] * o->Alpha, vLight );
              RenderTerrainAlphaBitmap( BITMAP_SUMMON_IMPACT, o->Position[0], o->Position[1], o->Scale, o->Scale,
                                        vLight, o->HeadAngle[1] );
              // RenderTerrainAlphaBitmap ( BITMAP_SUMMON_IMPACT, o->Position[0], o->Position[1], o->Scale*0.8f,
              // o->Scale*0.8f, vLight, o->HeadAngle[0] );
              ...
              for ( int i = 0; i < 5; ++i ) {
                ...
                RenderTerrainAlphaBitmap( BITMAP_LIGHT, o->Position[0], o->Position[1], o->Scale, o->Scale, vLight,
                                          -o->Angle[2] );
              }
            } else if ( o->SubType == 11 ) {
              vec3_t vLight;
          ...
          case BITMAP_CLOUD:
            if ( o->SubType == 0 ) {
              Vector( Luminosity * o->Light[0], Luminosity * o->Light[1], Luminosity * o->Light[2], Light );
              RenderTerrainAlphaBitmap( BITMAP_CLOUD, o->Position[0], o->Position[1], o->Scale, o->Scale, Light,
                                        -o->Angle[2] );
            }
            break;
          case MODEL_RAKLION_BOSS_MAGIC: {
          ...
          case BITMAP_MAGIC + 2:
            EnableAlphaBlend();
            Rotation = (int)WorldTime % 3'600 / (float)10.f;
          ...
          case BITMAP_MAGIC_ZIN: {
            ...
            switch ( o->SubType ) {
              case 0:
                ...
                break;
              case 1:
                Vector( o->Light[0] * o->Alpha / 2.5f, o->Light[1] * o->Alpha / 2.5f, o->Light[2] * o->Alpha / 2.5f,
                        vLight );
                break;
              case 2:
                Vector( o->Light[0] * o->Alpha, o->Light[1] * o->Alpha, o->Light[2] * o->Alpha, vLight );
          ...
          case BITMAP_ENEMY_INFLUENCE_GROUND:
            if ( o->SubType == 0 ) {
              ...
              RenderTerrainAlphaBitmap( o->Type, o->Position[0], o->Position[1], o->Scale * 1.6f, o->Scale * 1.6f,
                                        vLight );
          ...
          case BITMAP_LIGHTNING + 1:
            ...
            Vector( Luminosity, Luminosity, Luminosity, Light );
            RenderTerrainAlphaBitmap( BITMAP_LIGHTNING + 1, o->Position[0], o->Position[1], o->Scale, o->Scale, Light,
                                      -o->Angle[2] );
            break;
          case BITMAP_TWLIGHT:
          case BITMAP_SHOCK_WAVE:
          ...
          case BITMAP_CRATER:
            EnableAlphaTest();
            RenderTerrainAlphaBitmap( o->Type, o->Position[0], o->Position[1], o->StartPosition[0], o->StartPosition[1],
                                      o->Light );
            break;
          case MODEL_BLOW_OF_DESTRUCTION:
            if ( o->SubType == 0 ) {
              if ( o->LifeTime <= 24 ) {
                RenderTerrainAlphaBitmap( BITMAP_FLARE_BLUE, o->Position[0], o->Position[1], 4.f, 4.f, o->Light,
                                          -o->Angle[2] );
              }
            } else if ( o->SubType == 1 ) {
              if ( o->LifeTime <= 24 ) {
                RenderTerrainAlphaBitmap( BITMAP_FLARE_BLUE, o->Position[0], o->Position[1], 6.f, 6.f, o->Light,
                                          -o->Angle[2] );
              }
            }
            break;
