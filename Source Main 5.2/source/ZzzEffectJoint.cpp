      ...
      switch ( Type ) {
          ...
          switch ( o->SubType ) {
            ...
            case 24: {
              ...
              if ( 0.9f <= fRargleScale ) {
                ...
                CreateEffect( MODEL_SUMMONER_SUMMON_LAGUL, o->Position, o->Angle, vLight, 1, (OBJECT*)o, -1, 0, 0, 0,
                              fRargleScale );
              }
            } break;
            case 25: {
        ...
        case BITMAP_JOINT_THUNDER:
          ...
          switch ( o->SubType ) {
            ...
            case 2:
              ...
              Models[MODEL_PLAYER].TransformPosition( o->Target->BoneTransform[33], BitePosition, o->TargetPosition,
                                                      true );
              break;
        ...
        case BITMAP_FLARE_BLUE:
          ...
          if ( o->SubType == 0 || o->SubType == 18 ) {
            ...
            o->LifeTime = 40;
            o->MaxTails = 50;
            float rbias = (float)( rand() % 300 ) / 1'000;
            float gbias = (float)( rand() % 300 ) / 1'000;
            ...
            o->MaxTails     = 15;
            o->Direction[0] = (float)( rand() % 3'000 );
            o->Scale        = 30.f;
          } else if ( o->SubType == 8 ) {
            Vector( 0.f, 0.f, 0.f, o->Angle );
            Vector( 0.f, 0.f, 0.f, o->Direction );
  ...
  switch ( o->Type ) {
    ...
    case BITMAP_JOINT_ENERGY:
      switch ( o->SubType ) {
        ...
        case 43: {
          ...
          Vector( 2.0f + ( rand() % 10 ) * 0.03f, 0.4f + ( rand() % 10 ) * 0.03f, 0.4f + ( rand() % 10 ) * 0.03f,
                  vLight );
    ...
    case MODEL_SPEARSKILL: // 방어막
      ...
      if ( 2 == o->SubType ) {
        ...
        vec3_t MagicPos;
        GetMagicScrew( iIndex * 17'721, MagicPos, 1.4f );
        ...
        iFrame = ( ( iIndex % 2 ) ? iFrame : -iFrame ) + iIndex * 53'731;
        ...
        vDirTemp[0] = sinf( (float)( iFrame + 55'555 ) * fSpeed[0] ) * cosf( (float)iFrame * fSpeed[1] );
        vDirTemp[1] = sinf( (float)( iFrame + 55'555 ) * fSpeed[0] ) * sinf( (float)iFrame * fSpeed[1] );
        vDirTemp[2] = cosf( (float)( iFrame + 55'555 ) * fSpeed[0] );

        float fSinAdd = sinf( (float)( iFrame + 11'111 ) * fSpeed[2] );
        float fCosAdd = cosf( (float)( iFrame + 11'111 ) * fSpeed[2] );
        vDir[2]       = vDirTemp[0];
    ...
    case MODEL_FENRIR_SKILL_THUNDER:
      for ( int j = 0; j < o->MaxTails; j++ ) {
        ...
        o->Direction[0] = (float)( rand() % 1'024 - 512 ) / o->Scale;
        o->Direction[2] = (float)( rand() % 1'024 - 512 ) / o->Scale;
    ...
    case BITMAP_JOINT_THUNDER:
      ...
      for ( int j = 0; j < o->MaxTails; j++ ) {
        ...
        if ( o->SubType == 1 || o->SubType == 28 ) {
          ...
          o->Direction[0] = (float)( rand() % 1'024 - 512 ) * 0.7f / o->Scale;
          o->Direction[2] = (float)( rand() % 1'024 - 512 ) * 0.7f / o->Scale;
        } else if ( o->SubType == 18 ) {
          o->Direction[0] = (float)( rand() % 64 - 32 );
          o->Direction[2] = (float)( rand() % 64 - 32 );
        } else if ( o->SubType == 19 ) {
          o->Direction[0] = (float)( rand() % 1'024 - 512 ) / o->Scale;
          o->Direction[1] = (float)( rand() % 1'024 - 512 ) / o->Scale;
          o->Direction[2] = (float)( rand() % 1'024 - 512 ) / o->Scale;
        } else {
          o->Direction[0] = (float)( rand() % 1'024 - 512 ) / o->Scale;
          o->Direction[2] = (float)( rand() % 1'024 - 512 ) / o->Scale;
        ...
        } else if ( Distance < o->Velocity * 1.5f && ( o->SubType != 6 && o->SubType != 9 && o->SubType != 7 &&
                                                       o->SubType != 18 && o->SubType != 19 ) ) {
          if ( o->Scale == 50.f ) {
            CreateParticleFpsChecked( BITMAP_ENERGY, o->Position, o->Angle, o->Light );
            vec3_t Position;
            if ( rand_fps_check( 8 ) ) {
            ...
            if ( o->SubType == 0 || o->SubType == 27 ) {
              if ( (int)WorldTime % 1'000 < 500 && rand_fps_check( 16 ) ) {
      ...
      if ( o->SubType == 0 ) {
        if ( o->LifeTime > 15 ) {
          ...
          for ( int j = 0; j < o->MaxTails; j++ ) {
            ...
            o->Direction[0] = (float)( rand() % 1'400 - 700 ) / o->Scale;
            o->Direction[2] = (float)( rand() % 1'400 - 700 ) / o->Scale;
      ...
      if ( o->SubType == 0 || o->SubType == 10 || o->SubType == 18 ) {
          ...
          if ( o->SubType == 11 || o->SubType == 25 ) {
            fLastTarget =
                ( 100.f - fPos ) * ( o->Target->StartPosition[k] +
                                     25.f * cosf( (float)( iIndex * 51'231 + k * 3'711 + iFrame / 10 ) * 0.01f ) );
          } else {
            fLastTarget =
        ...
        if ( o->SubType == 45 && o->LifeTime <= 1 ) {
          CreateEffectFpsChecked( MODEL_CHANGE_UP_EFF, o->Target->Position, o->Target->Angle, o->Target->Light, 1,
                                  o->Target );
          CreateEffectFpsChecked( MODEL_CHANGE_UP_CYLINDER, o->Target->Position, o->Target->Angle, o->Target->Light, 1,
                                  o->Target );
        }
        {
          if ( o->SubType != 47 ) {
        ...
        for ( int j = 0; j < 8; ++j ) {
          if ( (int)o->NumTails < o->MaxTails - 1 ) {
            ...
            if ( o->SubType == 10 ) {
              ...
              CreateJointFpsChecked( BITMAP_JOINT_THUNDER, Light, o->Position, o->Angle, 3, NULL, rand() % 10 + 5.f, 5,
                                     10 );
              CreateJointFpsChecked( BITMAP_JOINT_THUNDER, Light, o->Position, o->Angle, 3, NULL, rand() % 8 + 4.f, 5,
                                     10 );
            } else if ( o->SubType == 8 ) {
          ...
          if ( o->m_bCreateTails && o->PKKey != 1 ) {
            if ( o->SubType < 2 ) {
              if ( o->Target != NULL ) {
                ...
                b->Transform( BoneTransform, o->Target->BoundingBoxMin, o->Target->BoundingBoxMax, &o->Target->OBB,
                              false );
  ...
  for ( int i = 0; i < MAX_JOINTS; i++ ) {
    ...
    if ( o->Live && o->NumTails > 0 && o->RenderFace != 0 ) {
      ...
      for ( int j = 0; j < (int)o->NumTails; j++ ) {
        ...
        float Scroll = (float)( (int)WorldTime % 1'000 ) * 0.001f;
...
void GetMagicScrew( int iParam, vec3_t vResult, float fSpeedRate )
{
  ...
  vDirTemp[0]   = sinf( (float)( iParam + 55'555 ) * fSpeed[0] ) * cosf( (float)iParam * fSpeed[1] );
  vDirTemp[1]   = sinf( (float)( iParam + 55'555 ) * fSpeed[0] ) * sinf( (float)iParam * fSpeed[1] );
  vDirTemp[2]   = cosf( (float)( iParam + 55'555 ) * fSpeed[0] );
  float fSinAdd = sinf( (float)( iParam + 11'111 ) * fSpeed[2] );
  float fCosAdd = cosf( (float)( iParam + 11'111 ) * fSpeed[2] );
