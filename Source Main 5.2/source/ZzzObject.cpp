...
bool Calc_RenderObject( OBJECT* o, bool Translate, int Select, int ExtraMon )
{
  ...
  if ( o->EnableBoneMatrix ) {
    b->Animation( o->BoneTransform, o->AnimationFrame, o->PriorAnimationFrame, o->PriorAction, o->Angle, o->HeadAngle,
                  false, !Translate );
  } else {
  ...
  if ( ( EditFlag != EDIT_NONE ) || ( EditFlag == EDIT_NONE && o->HiddenMesh != -2 ) ) {
    ...
    if ( o->RenderType == RENDER_DARK ) {
      ...
      if ( o->Type == 32 ) {
        ...
        b->StreamMesh = 2;
        b->RenderMesh( 2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                       -(int)WorldTime % 4'000 * 0.00025f, o->BlendMeshTexCoordV );
        b->RenderMesh( 2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                       -(int)WorldTime % 5'000 * 0.0002f, o->BlendMeshTexCoordV );
        b->StreamMesh = -1;
      ...
      if ( gMapManager.WorldActive == WD_65DOPPLEGANGER1 ) {
        ...
        b->RenderBody( RENDER_BRIGHT | RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, o->HiddenMesh );
      }
      ...
      b->RenderMesh( 0, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV );
      b->RenderMesh( 0, RENDER_CHROME | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
      ...
      if ( RenderHellasObjectMesh( o, b ) ) {
        ...
        b->RenderMesh( 1, RENDER_TEXTURE | RENDER_WAVE, 0.5f, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, o->HiddenMesh );
        ...
        if ( o->CurrentAction == MONSTER01_DIE || ( WorldTime - o->InitialSceneTime ) < 1'000 ) {
          ...
          b->RenderBody( RENDER_BRIGHT | RENDER_METAL, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                         o->BlendMeshTexCoordV, o->HiddenMesh, BITMAP_CHROME );
        }
        ...
        b->RenderBody( RENDER_TEXTURE | o->RenderType, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, o->HiddenMesh );
        ...
        b->RenderBody( RENDER_BRIGHT | RENDER_CHROME4, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, 1 );
        b->RenderBody( RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, o->HiddenMesh );
        ...
        b->RenderBody( RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, o->HiddenMesh );
        b->RenderBody( RENDER_BRIGHT | RENDER_CHROME, o->Alpha, o->BlendMesh, o->BlendMeshLight, -WorldTime * 0.0002f,
                       o->BlendMeshTexCoordV, BITMAP_CHROME );
        vec3_t vPos, vRelativePos, vLight;
        Vector( 1.f, 1.f, 1.f, vLight );
        ...
        b->RenderBody( RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                       -(int)WorldTime % 2'000 * 0.0005f, o->BlendMeshTexCoordV, o->HiddenMesh );
        b->StreamMesh = -1;
        ...
        b->RenderBody( RENDER_CHROME3 | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, o->HiddenMesh );
        ...
        if ( o->SubType == 2 || o->SubType == 3 ) {
          ...
          b->RenderMesh( 0, RENDER_TEXTURE, o->Alpha, 0, o->Alpha, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV,
                         o->HiddenMesh );
        }
      ...
      if ( bIsRendered == TRUE ) {
        ...
        if ( o->CurrentAction == MONSTER01_DIE ) {
          ...
          if ( o->AnimationFrame >= 13 ) // 11
          {
            ...
            b->RenderMesh( 0, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                           o->BlendMeshTexCoordV, BITMAP_GOOD_SANTA );
            b->RenderMesh( 1, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                           o->BlendMeshTexCoordV, BITMAP_GOOD_SANTA_BAGGAGE );
            b->RenderMesh( 2, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                           o->BlendMeshTexCoordV, o->HiddenMesh );
          ...
          } else if ( o->AnimationFrame >= 9 ) // 9
          {
            ...
            b->RenderMesh( 1, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                           o->BlendMeshTexCoordV, BITMAP_GOOD_SANTA_BAGGAGE );
            b->RenderMesh( 2, RENDER_TEXTURE, 1.0f - fFade, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                           o->BlendMeshTexCoordV, o->HiddenMesh );
        ...
        RenderAurora( BITMAP_LIGHTMARKS, RENDER_BRIGHT, o->Position[0], o->Position[1], 2.0f + fLumi, 2.0f + fLumi,
                      vLight );
        RenderAurora( BITMAP_LIGHTMARKS, RENDER_BRIGHT, o->Position[0], o->Position[1], 0.5f + fLumi, 0.5 + fLumi,
                      vLight );
        ...
        b->RenderBody( RENDER_BRIGHT | RENDER_TEXTURE, 0.9f, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV );
...
#endif // ASG_ADD_TIME_LIMIT_QUEST_NPC
      {
        ...
        if ( o->CurrentAction == MONSTER01_DIE ) {
          ...
          o->m_bRenderShadow = false;
          b->RenderBody( RENDER_TEXTURE, o->Alpha, -2, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV,
                         o->HiddenMesh );
          b->RenderMesh( 2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                         o->BlendMeshTexCoordU, o->BlendMeshTexCoordV );
        } else {
        ...
        if ( o->CurrentAction == 0 && rand_fps_check( 5 ) ) {
          ...
          fScale = ( rand() % 5 + 5 ) * 0.1f;
          Vector( 0.f, 0.f, 0.f, vRelativePos );
          vRelativePos[0] = -5 + ( rand() % 1'000 - 500 ) * 0.01f;
        ...
        if ( o->SubType == 1 ) {
          ...
          b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
                         o->BlendMeshTexCoordV, BITMAP_DAMAGE2 );
        } else if ( o->SubType == 2 ) {
          VectorCopy( o->Light, b->BodyLight );
        ...
        VectorCopy( o->Light, b->BodyLight );
        b->RenderBody( RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                       o->BlendMeshTexCoordV, o->HiddenMesh, BITMAP_DAMAGE1 );
        ...
        if ( o->SubType == 1 ) {
          ...
          VectorScale( b->BodyLight, 6.0f, b->BodyLight );
          b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
                         o->BlendMeshTexCoordV, BITMAP_KWAVE2 );
        } else {
          VectorCopy( o->Light, b->BodyLight );
          VectorScale( b->BodyLight, 6.0f, b->BodyLight );
          b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
        ...
        if ( o->SubType == 1 ) {
          ...
          b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
                         o->BlendMeshTexCoordV, BITMAP_VOLCANO_CORE );
        }
      ...
      if ( o->Type == MODEL_ARROW_TANKER_HIT || o->Type == MODEL_ARROW_TANKER ) {
        ...
        b->RenderBody( RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, -2, 1.f, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV,
                       o->HiddenMesh );
    ...
    case WD_0LORENCIA:
      switch ( o->Type ) {
        case MODEL_WATERSPOUT:
          ...
          o->BlendMeshTexCoordV = -(int)WorldTime % 1'000 * 0.001f;
          if ( rand_fps_check( 2 ) ) {
      ...
      switch ( o->Type ) {
        ...
        case 83:
          o->HiddenMesh = -2;
          {
            ...
            int  timing = (int)WorldTime % 10'000;

            if ( timing > 3'500 + inter && timing < 4'000 + inter ) {
              Smoke = true;
            }
            if ( Smoke ) {
              Vector( 1.f, 1.f, 1.f, Light );
    ...
    case WD_55LOGINSCENE: {
      switch ( o->Type ) {
        ...
        case 86:
          break;
        case 89: {
          int iTimeCheck = (int)WorldTime % 8'000;

          if ( iTimeCheck >= 7'950 ) {
            Vector( o->Position[0] + ( rand() % 2'048 - 1'024 ) * FPS_ANIMATION_FACTOR,
                    o->Position[1] + ( rand() % 2'048 - 1'024 ) * FPS_ANIMATION_FACTOR,
                    o->Position[2] + ( 3'000 + rand() % 600 ) * FPS_ANIMATION_FACTOR, Position );
  ...
  for ( int i = 0; i < 16; i++ ) {
    for ( int j = 0; j < 16; j++ ) {
      ...
      if ( g_Direction.m_CKanturu.IsMayaScene() || gMapManager.WorldActive == WD_51HOME_6TH_CHAR ||
           ...
           IsIceCity() || gMapManager.IsPKField() || IsDoppelGanger2() ) {
        OBJECT* o = ob->Head;
          ...
          if ( o != NULL ) {
            if ( gMapManager.WorldActive == WD_51HOME_6TH_CHAR && ( o->Type == 89 ) &&
              ...
              RenderObject_AfterCharacter( o );
                        ...
                        o->Type == 76 && TestFrustrum2D( o->Position[0] * 0.01f, o->Position[1] * 0.01f, -600.f ) ) {
              RenderObject_AfterCharacter( o );
            } else if ( gMapManager.IsPKField() && ( o->Type == 16 || o->Type == 67 || o->Type == 68 ) &&
                        TestFrustrum2D( o->Position[0] * 0.01f, o->Position[1] * 0.01f, -600.f ) ) {
              RenderObject_AfterCharacter( o );
...
void MoveObject( OBJECT* o )
{
  if ( gMapManager.WorldActive == 9 ) {
    if ( (int)WorldTime % 4'000 < 1'000 ) {
      if ( rand_fps_check( 100 ) ) {
        float  Luminosity = (float)( rand() % 12 + 4 ) * 0.1f;
        vec3_t Light;
        Vector( Luminosity * 0.2f, Luminosity * 0.3f, Luminosity * 0.5f, Light );
        AddTerrainLight( Hero->Object.Position[0] + rand() % 1'200 - 600,
                         Hero->Object.Position[1] + rand() % 1'200 - 600, Light, 12, PrimaryTerrainLight );
  ...
  if ( SceneFlag == LOG_IN_SCENE || SceneFlag == CHARACTER_SCENE ) {
    switch ( o->Type ) {
      case MODEL_LOGO:
        o->BlendMeshTexCoordV = -( (int)WorldTime % 4'000 * 0.00025f );
        break;
  ...
  switch ( gMapManager.WorldActive ) {
    ...
    case WD_1DUNGEON:
      switch ( o->Type ) {
        ...
        case 24:
          ...
          o->BlendMeshTexCoordV      = -(float)( (int)WorldTime % 1'000 ) * 0.001f;
          break;
        case 41:
    ...
    case WD_3NORIA:
      switch ( o->Type ) {
        ...
        case 41:
          o->BlendMesh          = 0;
          o->BlendMeshTexCoordV = (int)WorldTime % 2'000 * 0.0005f;
          break;
        case 42:
    ...
    case WD_4LOSTTOWER:
      switch ( o->Type ) {
        ...
        case 3:
        case 4:
          o->BlendMeshTexCoordU = -(int)WorldTime % 1'000 * 0.001f;
          break;
        case 19:
        case 20:
          o->BlendMesh          = 4;
    ...
    case WD_8TARKAN:
      switch ( o->Type ) {
        ...
        case 4: {
          ...
          o->BlendMeshTexCoordV = -(int)WorldTime % 10'000 * 0.0001f;
        ...
        case 11:
          o->BlendMeshTexCoordV = -(int)WorldTime % 10'000 * 0.0002f;
          break;

        case 12:
          o->BlendMeshTexCoordU = -(int)WorldTime % 50'000 * 0.00005f;
          o->BlendMeshTexCoordV = -(int)WorldTime % 50'000 * 0.00005f;
          break;
...
void MoveObjectSetting( int& objCount )
{
  ...
  if ( gMapManager.WorldActive == WD_10HEAVEN ) {
    ...
    if ( 0 == ( rand() % 10 ) ) {
      vec3_t Position;
      Vector( Hero->Object.Position[0] + (float)( rand() % 5'000 - 2'500 ),
              Hero->Object.Position[1] + (float)( rand() % 5'000 - 2'500 ), Hero->Object.Position[2] - 1000.f,
              Position );
...
void ItemObjectAttribute( OBJECT* o )
{
  ...
  switch ( o->Type ) {
    ...
    case MODEL_BILL_OF_BALROG:
      o->BlendMeshTexCoordV = -(float)( (int)( WorldTime ) % 2'000 ) * 0.0005f;
      break;
  ...
  for ( int i = 0; i < MAX_ITEMS; i++ ) {
    ...
    if ( o->Live ) {
      ...
      if ( o->Visible ) {
        ...
        if ( gMapManager.WorldActive == WD_10HEAVEN ) {
          o->Position[2] += 10.0f * (float)sinf( (float)( i * 1'237 + WorldTime ) * 0.002f );
...
void RenderPartObjectBody( BMD* b, OBJECT* o, int Type, float Alpha, int RenderType )
{
  ...
  //     }
    ...
    b->StreamMesh = 1;
    b->RenderMesh( 1, RENDER_TEXTURE | RENDER_BRIGHT | RENDER_CHROME, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                   o->BlendMeshTexCoordU, -(int)WorldTime % 2'000 * 0.0005f );
    b->RenderMesh( 2, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                   o->BlendMeshTexCoordV );
    ...
    if ( Type == MODEL_BONE_BLADE ) {
      ...
      b->BodyLight[2] = 0.4f;
      b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                     (int)WorldTime % 4'000 * 0.0004f - 0.7f, o->BlendMeshTexCoordV, BITMAP_CHROME7 );
      b->BodyLight[0] = 0.7f;
      b->BodyLight[1] = 0.7f;
      b->BodyLight[2] = 0.7f;
    } else if ( Type == MODEL_GRAND_VIPER_STAFF ) {
      b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                     (int)WorldTime % 2'000 * 0.0002f - 0.3f, (int)WorldTime % 2'000 * 0.0002f - 0.3f,
                     BITMAP_CHROME_ENERGY );
    } else {
      b->RenderMesh( 0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, o->BlendMesh, o->BlendMeshLight,
                     (int)WorldTime % 4'000 * 0.0002f - 0.3f, (int)WorldTime % 4'000 * 0.0002f - 0.3f, BITMAP_CHROME6 );
    }
    b->StreamMesh = -1;
  ...
  if ( bIsNotRendered == FALSE )
    ...
    if ( RenderType & RENDER_CHROME ) {
      ...
      b->RenderMesh( 0, RENDER_CHROME4 | RENDER_BRIGHT, Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV );
      Vector( 1.f, 1.f, 1.f, b->BodyLight );
    ...
    if ( g_isCharacterBuff( o, eDeBuff_CursedTempleRestraint ) ||
      ...
      if ( g_isCharacterBuff( o, eDeBuff_CursedTempleRestraint ) ) {
        float Luminosity = sinf( WorldTime * 0.002f ) * 0.3f + 0.5f;
        b->RenderMesh( 1, RENDER_TEXTURE, 0.4f + Luminosity, 0, o->BlendMeshLight * Luminosity, -WorldTime * 0.0005f,
                       WorldTime * 0.0005f );
      }
    ...
    if ( g_isCharacterBuff( o, eDeBuff_CursedTempleRestraint ) ||
      ...
      if ( g_isCharacterBuff( o, eDeBuff_CursedTempleRestraint ) ) {
        float Luminosity = sinf( WorldTime * 0.002f ) * 0.3f + 0.5f;
        b->RenderMesh( 2, RENDER_TEXTURE, 0.4f + Luminosity, 0, o->BlendMeshLight * Luminosity, -WorldTime * 0.0005f,
                       WorldTime * 0.0005f );
      }
    ...
    b->RenderMesh( 1, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                   o->BlendMeshTexCoordV );
    b->RenderMesh( 1, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 1, fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV,
                   BITMAP_PANDABODY_R );
    b->RenderMesh( 2, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                   o->BlendMeshTexCoordV, o->HiddenMesh );
    b->RenderMesh( 3, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
              ...
              o->Type <= MODEL_HELPER + 115 ) // InGameShop 장착 아이템 : 목걸이 (사파이어, 루비, 에메랄드)
  {
    ...
    b->RenderBody( RENDER_TEXTURE, 1.0f, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV,
                   o->HiddenMesh );
  ...
  else if ( g_CMonkSystem.EqualItemModelType( Type ) == MODEL_PHOENIX_SOUL_STAR ) // ok
  {
    ...
    if ( b->HideSkin == true ) {
      ...
      b->RenderMesh( 2, RENDER_CHROME | RENDER_BRIGHT, o->Alpha * fLumi, 2, o->BlendMeshLight * fLumi,
                     (double)( -int( WorldTime ) % 1'000 ) * 0.00009f, o->BlendMeshTexCoordV, -1 );
    } else {
      b->RenderBody( RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                     o->BlendMeshTexCoordV );
      b->RenderMesh( 2, RENDER_CHROME | RENDER_BRIGHT, o->Alpha * fLumi, 2, o->BlendMeshLight * fLumi,
    ...
    b->RenderMesh( 0, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                   o->BlendMeshTexCoordV, -1 );
    b->RenderMesh( 1, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                   (double)( -int( WorldTime ) % 1'000 ) * 0.00009f, -1 );
  ...
  /*
  else if (Type == MODEL_BODY_ARMOR + (MAX_CLASS * 2) + CLASS_RAGEFIGHTER || Type == MODEL_BODY_PANTS + (MAX_CLASS * 2)
  + CLASS_RAGEFIGHTER
                                ...
                                int iMonsterIndex )
{
  ...
  if ( Type == MODEL_LEGENDARY_STAFF ) {
    ...
    b->RenderBody( RenderType, Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, 0,
                   Texture );
                             ...
                             int ancientDiscriminator, int Select, int RenderType )
{
  ...
  if ( o->Type == MODEL_BILL_OF_BALROG ) {
    ...
    int iBone[] = {
      9, 20, 19, 10, 18, 28, 27, 36, 35, 38, 37, 53, 48, 62, 70, 72, 71, 78, 79, 80, 87, 90, 91, 106, 102
    };
    float fScale = 0.f;
  ...
  if ( !o->EnableShadow ) {
    ...
    if ( g_isCharacterBuff( o, eBuff_Cloaking ) ) {
      ...
      if ( o->Type == MODEL_POTION + 64 ) {
        RenderPartObjectBody( b, o, Type, Alpha, RenderType );
        RenderPartObjectBodyColor2( b, o, Type, 0.5f, RENDER_TEXTURE | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
                                    0.5f );
        RenderPartObjectBodyColor2( b, o, Type, 1.f, RENDER_CHROME4 | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
                                    1.f );
      } else if ( o->Type == MODEL_ILLUSION_SORCERER_COVENANT ) {
        VectorCopy( Light, b->BodyLight );
        RenderPartObjectBody( b, o, Type, Alpha, RenderType );
        RenderPartObjectBodyColor2( b, o, Type, 1.5f, RENDER_CHROME2 | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
                                    1.5f );
        RenderPartObjectBodyColor2( b, o, Type, 1.f, RENDER_CHROME4 | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
                                    1.f );
      ...
      } else if ( Level < 10 && g_pOption->GetRenderLevel() >= 2 ) //  +9
      {
        Vector( Light[0] * 0.9f, Light[1] * 0.9f, Light[2] * 0.9f, b->BodyLight );
        RenderPartObjectBody( b, o, Type, Alpha, RenderType );
        RenderPartObjectBodyColor( b, o, Type, Alpha, RENDER_CHROME | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
                                   1.f );
      ...
      } else if ( Level < 12 && g_pOption->GetRenderLevel() >= 3 ) //  +11
      {
        Vector( Light[0] * 0.9f, Light[1] * 0.9f, Light[2] * 0.9f, b->BodyLight );
        RenderPartObjectBody( b, o, Type, Alpha, RenderType );
        RenderPartObjectBodyColor2( b, o, Type, 1.f, RENDER_CHROME2 | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
                                    1.f );
        RenderPartObjectBodyColor( b, o, Type, Alpha, RENDER_METAL | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
                                   1.f );
        RenderPartObjectBodyColor( b, o, Type, Alpha, RENDER_CHROME | RENDER_BRIGHT | ( RenderType & RENDER_EXTRA ),
    ...
    if ( !g_isCharacterBuff( o, eDeBuff_Harden ) && !g_isCharacterBuff( o, eBuff_Cloaking ) &&
      ...
      if ( ( ExcellentFlags & 63 ) > 0 && ( o->Type < MODEL_WING || o->Type > MODEL_WINGS_OF_DARKNESS ) &&
        ...
        if ( b->HideSkin && MODEL_MISTERY_HELM <= o->Type && MODEL_LILIUM_HELM >= o->Type ) {
          int anMesh[6] = { 2, 1, 0, 2, 1, 2 };
          b->RenderMesh( anMesh[o->Type - ( MODEL_MISTERY_HELM )], RENDER_TEXTURE | RENDER_BRIGHT, Alpha, o->BlendMesh,
          ...
          b->RenderBody( RENDER_TEXTURE | RENDER_BRIGHT, Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                         o->BlendMeshTexCoordV );
        }
    ...
    if ( !p->m_pCloth[0] && iCloth > 0 ) {
      ...
      switch ( iCloth ) {
        case 1:
          ...
          pCloth[0]->Create( o, 2, 17, 0.0f, 9.0f, 7.0f, 5, 8, 45.0f, 85.0f, BITMAP_PANTS_G_SOUL, BITMAP_PANTS_G_SOUL,
