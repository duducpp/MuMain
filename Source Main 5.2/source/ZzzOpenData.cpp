...
void OpenPlayers()
{
  ModelsDump = new BMD[MAX_MODELS + 1'024];
  Models     = ModelsDump + ( rand() % 1'024 );
...
void OpenMonsterModel( EMonsterModelType Type )
{
  ...
  switch ( Type ) {
    ...
    case MONSTER_MODEL_HIDEOUS_RABBIT:
      ...
      break;
    case MONSTER_MODEL_WEREWOLF2:
      LoadWaveFile( SOUND_ELBELAND_BUTTERFLYPOLLUTION_MOVE01, L"Data\\Sound\\w52\\SE_Mon_butterflypollution_move01.wav",
                    1 );
...
void OpenBasicData( HDC hDC )
{
  ...
  LoadBitmap(L"Interface\\in_main_icon_bal1.tga"		, BITMAP_MVP_INTERFACE + 4, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main_icon_dl1.tga"		, BITMAP_MVP_INTERFACE + 5, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main_icon_dl2.tga"		, BITMAP_MVP_INTERFACE + 6, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main_number1.tga"		, BITMAP_MVP_INTERFACE + 7, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main_number2.tga"		, BITMAP_MVP_INTERFACE + 8, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main2.tga"		, BITMAP_MVP_INTERFACE + 9, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_failure.tga"		, BITMAP_MVP_INTERFACE + 10, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_success.tga"		, BITMAP_MVP_INTERFACE + 11, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\t_main.tga"		, BITMAP_MVP_INTERFACE + 12, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_no1.tga"		, BITMAP_MVP_INTERFACE + 13, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_no2.tga"		, BITMAP_MVP_INTERFACE + 14, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_no3.tga"		, BITMAP_MVP_INTERFACE + 15, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_ok1.tga"		, BITMAP_MVP_INTERFACE + 16, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_ok2.tga"		, BITMAP_MVP_INTERFACE + 17, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_ok3.tga"		, BITMAP_MVP_INTERFACE + 18, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_yes1.tga"		, BITMAP_MVP_INTERFACE + 19, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_yes2.tga"		, BITMAP_MVP_INTERFACE + 20, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_b_yes3.tga"		, BITMAP_MVP_INTERFACE + 21, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\m_main.tga"		, BITMAP_MVP_INTERFACE + 22, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main_number1_1.tga"		, BITMAP_MVP_INTERFACE + 23, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main_number2_1.tga"		, BITMAP_MVP_INTERFACE + 24, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\in_main_number0_2.tga"		, BITMAP_MVP_INTERFACE + 25, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_Rank_table.tga"		, BITMAP_MVP_INTERFACE + 26, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_Rank_rank.tga"		, BITMAP_MVP_INTERFACE + 27, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_Rank_D.tga"		, BITMAP_MVP_INTERFACE + 28, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_Rank_C.tga"		, BITMAP_MVP_INTERFACE + 29, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_Rank_B.tga"		, BITMAP_MVP_INTERFACE + 30, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_Rank_A.tga"		, BITMAP_MVP_INTERFACE + 31, GL_LINEAR,
  GL_CLAMP_TO_EDGE); LoadBitmap(L"Interface\\icon_Rank_S.tga"		, BITMAP_MVP_INTERFACE + 32, GL_LINEAR,
  GL_CLAMP_TO_EDGE);
  //icon_Rank_0
  ...
  */
  ...
  // LoadBitmap(L"Item\\goldenmaple_cham_R.jpg",	BITMAP_GOLDEN_MAPLE_CHAM_LAYER_R,	GL_LINEAR,
  // GL_CLAMP_TO_EDGE);
#endif // LJH_ADD_ITEMS_EQUIPPED_FROM_INVENTORY_SYSTEM_PART_2
